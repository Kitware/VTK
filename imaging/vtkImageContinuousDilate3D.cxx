...
//----------------------------------------------------------------------------
void vtkImageContinuousDilate3D::SetFilteredAxes(int axis0, int axis1, int axis2)
{
  int axes[3];
...
//----------------------------------------------------------------------------
void vtkImageContinuousDilate3D::ComputeMask()
{
...
void vtkImageContinuousDilate3D::ExecuteCenter(vtkImageRegion *inRegion, 
					  vtkImageRegion *outRegion)
{
  ...
  switch (inRegion->GetScalarType())
    {
    case VTK_FLOAT:
      vtkImageContinuousDilate3DExecute(this, inRegion, (float *)(inPtr), 
				   outRegion, (float *)(outPtr), 0);
      break;
    case VTK_INT:
      vtkImageContinuousDilate3DExecute(this, inRegion, (int *)(inPtr), 
				   outRegion, (int *)(outPtr), 0);
      break;
    case VTK_SHORT:
      vtkImageContinuousDilate3DExecute(this, inRegion, (short *)(inPtr), 
				   outRegion, (short *)(outPtr), 0);
      break;
    case VTK_UNSIGNED_SHORT:
      vtkImageContinuousDilate3DExecute(this, inRegion, (unsigned short *)(inPtr), 
				   outRegion, (unsigned short *)(outPtr), 0);
      break;
    case VTK_UNSIGNED_CHAR:
      vtkImageContinuousDilate3DExecute(this, inRegion, (unsigned char *)(inPtr), 
...
void vtkImageContinuousDilate3D::Execute(vtkImageRegion *inRegion, 
				    vtkImageRegion *outRegion)
{
  void *inPtr = inRegion->GetScalarPointer();
  void *outPtr = outRegion->GetScalarPointer();
