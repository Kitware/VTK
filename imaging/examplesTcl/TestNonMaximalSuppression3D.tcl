# This script is for testing the 3dNonMaximalSuppressionFilter.
# The filter works exclusively on the output of the 3d gradient filter.
...
vtkImage3dNonMaximalSuppressionFilter suppress;
