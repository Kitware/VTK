...
=========================================================================*/
// .NAME vtkImage4dMatFilter - Adds a border to an image.
// .SECTION Description
// vtkImage4dMatFilter adds a border to an image.  The border
...
#ifndef __vtkImage4dMatFilter_h
#define __vtkImage4dMatFilter_h

#include "vtkImageSource.h"
#include "vtkImageRegion.h"

class vtkImage4dMatFilter : public vtkImageSource
{
public:
  vtkImage4dMatFilter();
  char *GetClassName() {return "vtkImage4dMatFilter";};
