/*=========================================================================
  ...
  Module:    vtkImageSphereSource.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#include "vtkImageSphereSource.h"

//----------------------------------------------------------------------------
vtkImageSphereSource::vtkImageSphereSource()
{
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::SetWholeExtent(int dim, int *extent)
{
  int idx;
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::GetWholeExtent(int dim, int *extent)
{
  int idx;
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::SetCenter(int dim, float *center)
{
  int idx;
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::GetCenter(int dim, float *center)
{
  int idx;
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::UpdateImageInformation()
{
  this->CheckCache();
...
//----------------------------------------------------------------------------
void vtkImageSphereSource::Execute(vtkImageRegion *region)
{
  float d2, temp;
  float val;
  int *extent;
  ...
  temp = (float)(extent[0]) - this->Center[0];
  d2 = temp * temp;
  temp = (float)(extent[2]) - this->Center[1];
  d2 += temp * temp;
  temp = (float)(extent[4]) - this->Center[2];
  d2 += temp * temp;
  temp = (float)(extent[6]) - this->Center[3];
  d2 += temp * temp;
