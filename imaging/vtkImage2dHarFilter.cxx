/*=========================================================================
  ...
  Module:    vtkImage2dHarFilter.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
vtkImage2dHarFilter::vtkImage2dHarFilter()
{
...
void vtkImage2dHarFilter::InterceptCacheUpdate(vtkImageRegion *region)
{
  int bounds[4];
...
template <class T>
void vtkImage2dHarFilterExecute(vtkImage2dHarFilter *self,
...
void vtkImage2dHarFilter::Execute2d(vtkImageRegion *inRegion, 
				    vtkImageRegion *outRegion)
{
  ...
  for (levelIdx = 0; levelIdx < this->NumberLevels; ++levelIdx)
	...
	vtkImage2dHarFilterExecute(this, qSize0, qSize1,
