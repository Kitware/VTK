/*=========================================================================
  ...
  Module:    vtkImage3dMagnifyFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
// .NAME vtkImage3dMagnifyFilter - Magnifies an image by integer factors.
// .SECTION Description
// vtkImage3dMagnifyFilter maps each pixel of the input onto a nxmxp region
...
#ifndef __vtkImage3dMagnifyFilter_h
#define __vtkImage3dMagnifyFilter_h


#include "vtkImage3dDecomposedFilter.h"
#include "vtkImage1dMagnifyFilter.h"

class vtkImage3dMagnifyFilter : public vtkImage3dDecomposedFilter
{
public:
  vtkImage3dMagnifyFilter();
  char *GetClassName() {return "vtkImage3dMagnifyFilter";};
