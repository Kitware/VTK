...
IF (NOT VTK_LIBRARY_PATH)
  ...
  LINK_DIRECTORIES(${VTK_BINARY_DIR}/Utilities/expat)
ENDIF (NOT VTK_LIBRARY_PATH)
...
IF(NOT CMAKE_COMPILER_IS_GNUCXX)
  ...
  IF(CMAKE_SYSTEM MATCHES "OSF1-V.*")
     SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nopt")
  ENDIF(CMAKE_SYSTEM MATCHES "OSF1-V.*")
ENDIF(NOT CMAKE_COMPILER_IS_GNUCXX)

IF(APPLE)
  SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-deprecated")
  SET(CMAKE_CXX_SHLIB_LINK_FLAGS "${CMAKE_CXX_SHLIB_LINK_FLAGS} -multiply_defined suppress")
  IF (VTK_USE_CARBON)
