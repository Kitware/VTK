...
vtkParallelCoordinatesHistogramRepresentation::vtkParallelCoordinatesHistogramRepresentation()
{
  ...
  this->OutlierFilter->SetInputData(
    vtkComputeHistogram2DOutliers::INPUT_TABLE_DATA, this->InputArrayTable);
  //                                          this->HistogramFilter->GetOutputPort(vtkPairwiseExtractHistogram2D::REORDERED_INPUT));
  this->OutlierFilter->SetInputConnection(
    vtkComputeHistogram2DOutliers::INPUT_HISTOGRAMS_MULTIBLOCK,
...
int vtkParallelCoordinatesHistogramRepresentation::PlaceLines(
...
// redirect the line plotting function to the histogram plotting function,
// if histograms are enabled
int vtkParallelCoordinatesHistogramRepresentation::PlaceCurves(
  vtkPolyData* polyData, vtkTable* data, vtkIdTypeArray* idsToPlot)
{
  if (this->UseHistograms)
  {
...
int vtkParallelCoordinatesHistogramRepresentation::PlaceSelection(
