...
class VTK_EXPORT vtkHyperTreeGrid : public vtkDataSet
{
public:
  ...
  vtkSetVector3Macro(NumberOfRootCells,vtkIdType);
  vtkGetVector3Macro(NumberOfRootCells,vtkIdType);
...
protected:
  ...
  void TraverseDualRecursively(vtkHyperTreeLightWeightCursor* neighborhood,
                               double origin[3], double size[3], int level);
