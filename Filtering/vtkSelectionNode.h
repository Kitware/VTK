...
// vtkSelectionNodes and does not usually contain any selection values. If
...
public:
  ...
  virtual void DeepCopy(vtkSelectionNode* input);
  ...
  // datasets.
  virtual void CopyChildren(vtkSelectionNode*);

  // vtkSelectionNode specific keys.
...
private:
  ...
  vtkSelectionNodeInternals* Internal;
};
