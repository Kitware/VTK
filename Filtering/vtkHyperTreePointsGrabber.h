/*=========================================================================
  ...
  Module:    vtkHyperTreePointsGrabber.h
...
=========================================================================*/
// .NAME vtkHyperTreePointsGrabber - An object used by filters to
...
#ifndef __vtkHyperTreePointsGrabber_h
#define __vtkHyperTreePointsGrabber_h

#include "vtkObject.h"

class VTK_EXPORT vtkHyperTreePointsGrabber : public vtkObject
{
public:
  vtkTypeMacro(vtkHyperTreePointsGrabber,vtkObject);
...
protected:
  ...
  vtkHyperTreePointsGrabber();
  virtual ~vtkHyperTreePointsGrabber();
  
  int Dimension;
  
private:
  vtkHyperTreePointsGrabber(const vtkHyperTreePointsGrabber&);  // Not implemented.
  void operator=(const vtkHyperTreePointsGrabber&);    // Not implemented.
};
