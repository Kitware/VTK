...
{
  // Read file name.
  char* filename = vtkTestUtilities::ExpandDataFileName(argc, argv, "Data/MFIXReader/BUB01.RES");
  ...
  vtkSmartPointer<vtkMFIXReader> reader = vtkSmartPointer<vtkMFIXReader>::New();
