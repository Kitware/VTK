/*=========================================================================
  ...
  Module:    TestPolyDataReaderFactoryVTK.cxx
...
=========================================================================*/
// .NAME Test of vtkPolyDataReaderFactory with .vtk file. 
// .SECTION Description
//
...
int TestPolyDataReaderFactoryVTK( int argc, char *argv[] )
{
  // Read file name.
  ...
  if (reader->CanReadFile(fname)==0)
    {
    cerr << " vtkPolyDataReaderFactory trouble reading VTK file: aborting" << endl;
    return 1;
    }
