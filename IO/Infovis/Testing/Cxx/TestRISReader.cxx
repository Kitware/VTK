...
int TestRISReader(int argc, char* argv[])
{
  ...
  TestValue<vtkStdString>(table->GetColumnName(0), "TY", "Column 0", error_count);
  TestValue<vtkStdString>(table->GetColumnName(1), "T1", "Column 1", error_count);
  TestValue<vtkStdString>(table->GetColumnName(2), "JF", "Column 2", error_count);
  TestValue<vtkStdString>(table->GetColumnName(13), "KW", "Column 13", error_count);
  TestValue<vtkStdString>(table->GetColumnName(14), "N1", "Column 14", error_count);
  TestValue<vtkStdString>(table->GetColumnName(15), "UR", "Column 15", error_count);

  // Test a sampling of the table values ...
  TestValue<vtkStdString>(table->GetValue(0, 0).ToString(), "JOUR", "Value 0, 0", error_count);
  TestValue<vtkStdString>(table->GetValue(0, 1).ToString(),
  ...
  TestValue<vtkStdString>(table->GetValue(13, 10).ToString(),
    "Zhou, P.;Li, X.-H.;Liang, Y.-J.;Deng, F.-G.;Zhou, H.-Y.", "value 13, 10", error_count);
  TestValue<vtkStdString>(table->GetValue(13, 11).ToString(),
  ...
  TestValue<vtkStdString>(table->GetValue(13, 13).ToString(),
