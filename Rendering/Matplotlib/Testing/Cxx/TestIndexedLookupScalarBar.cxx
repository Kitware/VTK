...
int TestIndexedLookupScalarBar(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkBandedPolyDataContourFilter> bands =
  ...
  vtkSmartPointer<vtkScalarBarWidget> scalarWidgetB = vtkSmartPointer<vtkScalarBarWidget>::New();
  ...
  vtkScalarBarRepresentation* srep =
    vtkScalarBarRepresentation::SafeDownCast(scalarWidgetB->GetRepresentation());
  ...
  vtkSmartPointer<vtkScalarBarWidget> scalarWidgetC = vtkSmartPointer<vtkScalarBarWidget>::New();
