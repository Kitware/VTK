...
//----------------------------------------------------------------------------
// Vtkpythontkwidgets_Init
// Called upon system startup to create the widget commands.
extern "C" {VTK_EXPORT int Vtkpythontkwidgets_Init(Tcl_Interp *interp);}
...
int Vtkpythontkwidgets_Init(Tcl_Interp *interp)
{
  if (Tcl_PkgProvide(interp, (char *) "Vtkpythontkwidgets", (char *) "1.2") != TCL_OK) 
    {
    return TCL_ERROR;
    }
