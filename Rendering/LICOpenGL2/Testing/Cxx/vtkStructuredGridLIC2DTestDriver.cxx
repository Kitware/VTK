...
int vtkStructuredGridLIC2DTestDriver(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkExtractGrid> extractVOI = vtkSmartPointer<vtkExtractGrid>::New();
  ...
  vtkSmartPointer<vtkStructuredGridLIC2D> filter = vtkSmartPointer<vtkStructuredGridLIC2D>::New();
  ...
  for (int kk = 0; kk < num_partitions; kk++)
  {
    ...
    vtkSmartPointer<vtkStructuredGrid> clone2 = vtkSmartPointer<vtkStructuredGrid>::New();
