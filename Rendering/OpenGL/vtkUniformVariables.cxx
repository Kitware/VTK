...
public:
  ...
  const int *GetValues()
  {
   ...
   void Send(int location) override
   {
      switch(this->Size)
      {
        case 1:
  ...
  vtkUniform *Clone() const override
  {
...
public:
  ...
  ~vtkUniformVectorFloat() override
  {
      delete[] this->Values;
  }
