...
#
ren1.AddViewProp(gridActor)
ren1.AddViewProp(textActorL)
ren1.AddViewProp(singleLineTextActorT)
ren1.AddViewProp(textActorLA)
ren1.AddViewProp(textActorC)
ren1.AddViewProp(textActorR)
ren1.AddViewProp(singleLineTextActorB)
ren1.AddViewProp(singleLineTextActorC)
ren1.AddViewProp(singleLineTextActorLTT)
ren1.AddViewProp(singleLineTextActorRTT)
ren1.AddViewProp(singleLineTextActorTB)
ren1.AddViewProp(singleLineTextActorBR)
ren1.AddViewProp(singleLineTextActorBL)
ren1.AddViewProp(singleLineTextActorCC)
