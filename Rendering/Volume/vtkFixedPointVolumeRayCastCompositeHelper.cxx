...
struct vtkFixedPointCompositeHelperGenerateImageOneSimpleNNFunctor
{
...
// this point (if the accumulated opacity is higher than some threshold).
// Finally we move on to the next sample along the ray.
struct vtkFixedPointCompositeHelperGenerateImageOneNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
struct vtkFixedPointCompositeHelperGenerateImageTwoDependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
struct vtkFixedPointCompositeHelperGenerateImageFourDependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
struct vtkFixedPointCompositeHelperGenerateImageIndependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
...
struct vtkFixedPointCompositeHelperGenerateImageOneSimpleTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
struct vtkFixedPointCompositeHelperGenerateImageOneTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
// the ray.
struct vtkFixedPointCompositeHelperGenerateImageTwoDependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
struct vtkFixedPointCompositeHelperGenerateImageFourDependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vtkNotUsed(vol))
...
// point (if the accumulated opacity is higher than some threshold). Finally we
// move on to the next sample along the ray.
struct vtkFixedPointCompositeHelperGenerateImageIndependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
  ...
  int threadID, int threadCount, vtkVolume* vol, vtkFixedPointVolumeRayCastMapper* mapper)
{
  ...
  if (mapper->ShouldUseNearestNeighborInterpolation(vol))
  {
    ...
    if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 1)
    {
      ...
      {
        vtkFixedPointCompositeHelperGenerateImageOneSimpleNNFunctor functor;
      ...
      {
        vtkFixedPointCompositeHelperGenerateImageOneNNFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    {
      vtkFixedPointCompositeHelperGenerateImageIndependentNNFunctor functor;
      if (!vtkArrayDispatch::Dispatch::Execute(
            dataArray, functor, threadID, threadCount, mapper, vol))
      {
        functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    else
    {
      ...
      {
        vtkFixedPointCompositeHelperGenerateImageTwoDependentNNFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      else
      {
        ...
        {
          vtkFixedPointCompositeHelperGenerateImageFourDependentNNFunctor functor;
  ...
  else
  {
    ...
    if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 1)
    {
      ...
      if (mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0)
      {
        vtkFixedPointCompositeHelperGenerateImageOneSimpleTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      {
        vtkFixedPointCompositeHelperGenerateImageOneTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    {
      vtkFixedPointCompositeHelperGenerateImageIndependentTrilinFunctor functor;
      if (!vtkArrayDispatch::Dispatch::Execute(
            dataArray, functor, threadID, threadCount, mapper, vol))
      {
        functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    else
    {
      ...
      if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 2)
      {
        vtkFixedPointCompositeHelperGenerateImageTwoDependentTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      else
      {
        if (scalarType == VTK_UNSIGNED_CHAR)
        {
          vtkFixedPointCompositeHelperGenerateImageFourDependentTrilinFunctor functor;
          if (!vtkArrayDispatch::DispatchByValueType<vtkTypeList::Create<unsigned char>>::Execute(
                dataArray, functor, threadID, threadCount, mapper, vol))
          {
            functor(dataArray, threadID, threadCount, mapper, vol);
