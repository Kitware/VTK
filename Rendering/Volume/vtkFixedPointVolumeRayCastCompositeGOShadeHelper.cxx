...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageOneSimpleNNFunctor
{
...
// this point (if the accumulated opacity is higher than some threshold).
// Finally we move on to the next sample along the ray.
struct vtkFixedPointCompositeGOShadeHelperGenerateImageOneNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageTwoDependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageFourDependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageIndependentNNFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageOneSimpleTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageOneTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
// the ray.
struct vtkFixedPointCompositeGOShadeHelperGenerateImageTwoDependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
struct vtkFixedPointCompositeGOShadeHelperGenerateImageFourDependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
...
// point (if the accumulated opacity is higher than some threshold). Finally, we
// move on to the next sample along the ray.
struct vtkFixedPointCompositeGOShadeHelperGenerateImageIndependentTrilinFunctor
{
  template <class TArray>
  void operator()(TArray* dataArray, int threadID, int threadCount,
    vtkFixedPointVolumeRayCastMapper* mapper, vtkVolume* vol)
  {
    ...
    for (k = 0; k < numSteps; k++)
    {
      ...
      VTKKWRCHelper_LookupAndCombineIndependentColorsGOInterpolateShadeUS(colorTable,
        scalarOpacityTable, gradientOpacityTable, diffuseShadingTable, specularShadingTable, val,
        mag, weights, components, tmp)
...
void vtkFixedPointVolumeRayCastCompositeGOShadeHelper::GenerateImage(
  int threadID, int threadCount, vtkVolume* vol, vtkFixedPointVolumeRayCastMapper* mapper)
{
  ...
  if (mapper->ShouldUseNearestNeighborInterpolation(vol))
  {
    ...
    if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 1)
    {
      ...
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageOneSimpleNNFunctor functor;
      ...
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageOneNNFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    {
      vtkFixedPointCompositeGOShadeHelperGenerateImageIndependentNNFunctor functor;
      if (!vtkArrayDispatch::Dispatch::Execute(
            dataArray, functor, threadID, threadCount, mapper, vol))
      {
        functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    else
    {
      ...
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageTwoDependentNNFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      else
      {
        if (scalarType == VTK_UNSIGNED_CHAR)
        {
          ...
          vtkFixedPointCompositeGOShadeHelperGenerateImageFourDependentNNFunctor functor;
  ...
  else
  {
    ...
    if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 1)
    {
      ...
      if (mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0)
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageOneSimpleTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageOneTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    {
      vtkFixedPointCompositeGOShadeHelperGenerateImageIndependentTrilinFunctor functor;
      if (!vtkArrayDispatch::Dispatch::Execute(
            dataArray, functor, threadID, threadCount, mapper, vol))
      {
        functor(dataArray, threadID, threadCount, mapper, vol);
    ...
    else
    {
      ...
      if (mapper->GetCurrentScalars()->GetNumberOfComponents() == 2)
      {
        vtkFixedPointCompositeGOShadeHelperGenerateImageTwoDependentTrilinFunctor functor;
        if (!vtkArrayDispatch::Dispatch::Execute(
              dataArray, functor, threadID, threadCount, mapper, vol))
        {
          functor(dataArray, threadID, threadCount, mapper, vol);
      ...
      else
      {
        if (scalarType == VTK_UNSIGNED_CHAR)
        {
          vtkFixedPointCompositeGOShadeHelperGenerateImageFourDependentTrilinFunctor functor;
          if (!vtkArrayDispatch::DispatchByValueType<vtkTypeList::Create<unsigned char>>::Execute(
                dataArray, functor, threadID, threadCount, mapper, vol))
          {
            functor(dataArray, threadID, threadCount, mapper, vol);
