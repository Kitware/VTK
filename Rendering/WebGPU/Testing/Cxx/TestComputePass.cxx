...
/**
 * This test multiplies element-wise two vectors.
 * This tests the basic functionalities of the compute pipeline
 */
...
int TestComputePass(int argc, char** argv)
{
  ...
  inputValues1Buffer->SetData(inputDataArray1);
  ...
  for (int i = 0; i < DATA_SIZE; i++)
  {
    auto input1Value = inputDataArray1->GetValue(i);
