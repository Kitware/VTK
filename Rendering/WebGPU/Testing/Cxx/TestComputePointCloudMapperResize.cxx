...
/**
 * This test renders a point cloud with the WebGPU compute API and resizes the render window. The
 * point cloud mapper should also resize and the resulting image should still be correct
 */
...
//------------------------------------------------------------------------------
int TestComputePointCloudMapperResize(int argc, char* argv[])
{
