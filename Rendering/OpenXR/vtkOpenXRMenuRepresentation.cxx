...
Module:    vtkOpenXRMenuRepresentation.cxx
...
vtkStandardNewMacro(vtkOpenXRMenuRepresentation);

class vtkOpenXRMenuRepresentation::InternalElement
{
public:
...
//------------------------------------------------------------------------------
vtkOpenXRMenuRepresentation::vtkOpenXRMenuRepresentation()
{
  this->VisibilityOff();
}
...
void vtkOpenXRMenuRepresentation::PushFrontMenuItem(
  const char* name, const char* text, vtkCommand* cmd)
{
  vtkOpenXRMenuRepresentation::InternalElement* el =
    new vtkOpenXRMenuRepresentation::InternalElement();
...
void vtkOpenXRMenuRepresentation::RenameMenuItem(const char* name, const char* text)
{
...
void vtkOpenXRMenuRepresentation::RemoveMenuItem(const char* name)
{
...
void vtkOpenXRMenuRepresentation::RemoveAllMenuItems()
{
...
void vtkOpenXRMenuRepresentation::StartComplexInteraction(
...
void vtkOpenXRMenuRepresentation::EndComplexInteraction(
  vtkRenderWindowInteractor*, vtkAbstractWidget*, unsigned long, void*)
{
  this->VisibilityOff();
}

void vtkOpenXRMenuRepresentation::ComplexInteraction(
...
//------------------------------------------------------------------------------
void vtkOpenXRMenuRepresentation::ReleaseGraphicsResources(vtkWindow* w)
{
  for (auto& menu : this->Menus)
  {
...
//------------------------------------------------------------------------------
int vtkOpenXRMenuRepresentation::RenderOverlay(vtkViewport* v)
{
...
//------------------------------------------------------------------------------
vtkTypeBool vtkOpenXRMenuRepresentation::HasTranslucentPolygonalGeometry()
{
  return 0;
}

//------------------------------------------------------------------------------
void vtkOpenXRMenuRepresentation::BuildRepresentation()
{
  vtkOpenXRRenderWindow* renWin =
    static_cast<vtkOpenXRRenderWindow*>(this->Renderer->GetRenderWindow());
...
//------------------------------------------------------------------------------
void vtkOpenXRMenuRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
