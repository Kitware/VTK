 ...
 * @brief   Widget representation for vtkOpenXRPanelWidget
 * Implementation of the popup panel representation for the
 * vtkOpenXRPanelWidget.
...
#ifndef vtkOpenXRMenuRepresentation_h
#define vtkOpenXRMenuRepresentation_h
...
class VTKRENDERINGOPENXR_EXPORT vtkOpenXRMenuRepresentation : public vtkWidgetRepresentation
{
public:
  /**
   * Instantiate the class.
   */
  static vtkOpenXRMenuRepresentation* New();

  //@{
  /**
   * Standard methods for the class.
   */
  vtkTypeMacro(vtkOpenXRMenuRepresentation, vtkWidgetRepresentation);
  void PrintSelf(ostream& os, vtkIndent indent) override;
  //@}

  //@{
  /**
   * Methods to interface with the vtkOpenXRPanelWidget.
   */
...
protected:
  ...
  ~vtkOpenXRMenuRepresentation() override;
...
private:
  vtkOpenXRMenuRepresentation(const vtkOpenXRMenuRepresentation&) = delete;
  void operator=(const vtkOpenXRMenuRepresentation&) = delete;
};
