...
Module:    vtkOpenXRHardwarePicker.cxx
...
=========================================================================*/
#include "vtkOpenXRHardwarePicker.h"
...
vtkStandardNewMacro(vtkOpenXRHardwarePicker);

vtkOpenXRHardwarePicker::vtkOpenXRHardwarePicker()
{
...
// set up for a pick
void vtkOpenXRHardwarePicker::Initialize()
{
  this->vtkAbstractPropPicker::Initialize();
}

// Pick from the given collection
int vtkOpenXRHardwarePicker::PickProp(
  double p0[3], double wxyz[4], vtkRenderer* renderer, vtkPropCollection*, bool actorPassOnly)
{
  ...
  vtkOpenXRRenderWindow* renWin = vtkOpenXRRenderWindow::SafeDownCast(renderer->GetRenderWindow());
  if (!renWin)
  {
    return 0;
  }
...
void vtkOpenXRHardwarePicker::PrintSelf(ostream& os, vtkIndent indent)
{
