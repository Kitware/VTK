...
// SPDX-License-Identifier: BSD-3-Clause#include "vtkActor.h"
...
/**
 * Testing that vtkAnariRenderWindow is rendering a RGBA image coming from a simple pipeline.
 */
int TestAnariRenderWindowRGBA(int argc, char* argv[])
{
  ...
  renderWindow->Render();
  int result = vtkRegressionTestImageRGBA(renderWindow);
