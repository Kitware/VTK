...
Module:    vtkFramebufferDepthPeelingPass.cxx
...
vtkStandardNewMacro(vtkFramebufferDepthPeelingPass);
vtkCxxSetObjectMacro(vtkFramebufferDepthPeelingPass,TranslucentPass,vtkRenderPass);
vtkCxxSetObjectMacro(vtkFramebufferDepthPeelingPass, OpaqueZTexture, vtkTextureObject);
vtkCxxSetObjectMacro(vtkFramebufferDepthPeelingPass, OpaqueRGBATexture, vtkTextureObject);

// ----------------------------------------------------------------------------
vtkFramebufferDepthPeelingPass::vtkFramebufferDepthPeelingPass() :
  Framebuffer(nullptr)
{
...
void vtkFramebufferDepthPeelingPass::ReleaseGraphicsResources(vtkWindow *w)
{
...
// ----------------------------------------------------------------------------
void vtkFramebufferDepthPeelingPass::PrintSelf(ostream& os, vtkIndent indent)
{
...
vtkTextureObject *vtkFramebufferDepthPeelingPassCreateTextureObject(
...
void vtkFramebufferDepthPeelingPass::BlendIntermediatePeels(
...
void vtkFramebufferDepthPeelingPass::BlendFinalPeel(vtkOpenGLRenderWindow *renWin)
{
...
// \pre s_exists: s!=0
void vtkFramebufferDepthPeelingPass::Render(const vtkRenderState *s)
{
  ...
  if (this->TranslucentRGBATexture[0] == NULL)
  {
    for (i = 0; i < 3; i++)
    {
      this->TranslucentRGBATexture[i] =
        vtkFramebufferDepthPeelingPassCreateTextureObject(
          renWin, this->ViewportWidth, this->ViewportHeight,
          4, false, NULL);
    }
    this->TranslucentZTexture[0] = vtkFramebufferDepthPeelingPassCreateTextureObject(
      renWin, this->ViewportWidth, this->ViewportHeight, 1, true, NULL);
    this->TranslucentZTexture[1] = vtkFramebufferDepthPeelingPassCreateTextureObject(
      renWin, this->ViewportWidth, this->ViewportHeight, 1, true, NULL);
  }
...
//------------------------------------------------------------------------------
bool vtkFramebufferDepthPeelingPass::PostReplaceShaderValues(std::string &,
                                              std::string &,
...
//------------------------------------------------------------------------------
bool vtkFramebufferDepthPeelingPass::SetShaderParameters(vtkShaderProgram *program,
