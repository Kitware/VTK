...
{
  // TODO This will require an additional volumetric pass to process the regions
  // of the volumes that extend beyond the translucent geometry. Need to be
  // careful to include opaque depths in the far-cutoff.
}
