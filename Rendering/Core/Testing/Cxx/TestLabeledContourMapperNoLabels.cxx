...
//------------------------------------------------------------------------------
int TestLabeledContourMapperNoLabels(int argc, char* argv[])
{
  ...
  // XXX:here we make sure no labels are visible and test whether
  // or not the mapper behave nicely in such a case
  mapper->SetSkipDistance(100000);
