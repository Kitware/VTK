...
if {[catch {set VTK_TCL $env(VTK_TCL)}]} { 
    set VTK_TCL "../../examplesTcl" 
}
if {[catch {set VTK_DATA $env(VTK_DATA)}]} { 
...
#        $cam SetDirectionOfProjection -0.6 -0.5 -0.6
...
renWin SetFileName TestICPTransform.tcl.ppm
