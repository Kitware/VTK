...
vtkActor weightedTransActor
    ...
    [weightedTransActor GetProperty] SetRepresentationToWireframe
...
set s [scale .scale -orient horizontal -from -120 -to 120 -length 300 \
	-command cmd -variable rotatedAngle]
pack $s

#renWin SetFileName banana.tcl.ppm
