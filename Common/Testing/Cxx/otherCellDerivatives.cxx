...
// .NAME 
// .SECTION Description
// this program tests the CellDerivatives method for each cell type
...
int TestOCD(ostream& strm)
{
  // actual test
  vtkIdList *ids = vtkIdList::New();
  int i, j, k;
  strm << "Test vtkCell::CellDerivative Start" << endl;

  vtkVertex *vertex = vtkVertex::New();
  float vertexCoords[1][1];

  vertex->GetPointIds()->SetId(0,0);
  vertex->GetPoints()->SetPoint (0, 0.0, 0.0, 0.0);
...
int otherCellDerivatives(int,char *[])
{
