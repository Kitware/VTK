...
//BTX
  ...
  static void GetDataTypeValueRange(unsigned char range[2])
    { range[0] = vtkUnsignedCharArray::GetDataTypeValueMin();
      range[1] = vtkUnsignedCharArray::GetDataTypeValueMax(); }
//ETX
