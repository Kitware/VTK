...
{
  vtkCylindricalTransform* cylindricalTransform = static_cast<vtkCylindricalTransform*>(transform);
...
template <class T>
void vtkCylindricalToRectangular(const T inPoint[3], T outPoint[3], T derivative[3][3])
{
  T r = inPoint[0];
...
void vtkCylindricalTransform::ForwardTransformPoint(const float inPoint[3], float outPoint[3])
{
  vtkCylindricalToRectangular(inPoint, outPoint, static_cast<float(*)[3]>(nullptr));
}

void vtkCylindricalTransform::ForwardTransformPoint(const double inPoint[3], double outPoint[3])
{
  vtkCylindricalToRectangular(inPoint, outPoint, static_cast<double(*)[3]>(nullptr));
}
...
void vtkCylindricalTransform::InverseTransformPoint(const float inPoint[3], float outPoint[3])
{
  vtkRectangularToCylindrical(inPoint, outPoint);
}

void vtkCylindricalTransform::InverseTransformPoint(const double inPoint[3], double outPoint[3])
{
  vtkRectangularToCylindrical(inPoint, outPoint);
}
