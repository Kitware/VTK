...
//BTX
  ...
  static void GetDataTypeValueRange(unsigned long long range[2])
    { range[0] = vtkUnsignedLongLongArray::GetDataTypeValueMin();
      range[1] = vtkUnsignedLongLongArray::GetDataTypeValueMax(); }
//ETX
