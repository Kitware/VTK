...
static int numUniqueStringComplete[2] = { 8, 8 };
static int numUniqueStringSubset[2] = { 4, 8 };

static bool CheckUniques(
  vtkAbstractArray* arr, int* uniqueSizeBds, double uncertainty, double minProminence)
{
  bool ok = true;
  if (!arr)
  {
