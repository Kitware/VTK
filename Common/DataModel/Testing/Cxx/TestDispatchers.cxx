...
template <>
struct FieldType<vtkDoubleArray>
{
  enum
  {
...
bool TestDoubleDispatch()
{
  ...
  int result =
    dispatcher.Go(as<vtkObject>(doubleArray.GetPointer()), as<vtkObject>(stringArray.GetPointer()));
  test_expression(result == 1, "double array dispatch failed with statefull functor");
