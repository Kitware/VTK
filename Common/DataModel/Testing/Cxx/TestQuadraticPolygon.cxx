...
{
  return (vtkMath::Distance2BetweenPoints(point1, point2) < this->Tolerance * this->Tolerance);
}
...
int vtkQuadraticPolygonTest::TestGetPermutations()
{
  ...
  vtkQuadraticPolygon::GetPermutationFromPolygon(8, permutationFromPolygon);
