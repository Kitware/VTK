...
print"Processing NumPts:", numPts
print
...
print "Build Point Locator:", time
...
print "    Closest point probing: ", opTime
...
print "    Delete Point Locator:", time2
print "    Point Locator (Total):", time+time2
print
...
print "Build Static Point Locator:", StaticTime
...
print "    Static Closest point probing: ", staticOpTime
...
print "    Delete Point Locator:", StaticTime2
print "    Static Point Locator (Total):", StaticTime+StaticTime2
print

# Print out the speedups
print "Speed ups:"
print "    Build:", time/StaticTime
if StaticTime2 > 0.0:
    print "    Delete:", time2/StaticTime2
else:
    print "    Delete: (really big)"
print "    Total:", (time+time2)/(StaticTime+StaticTime2)
