...
public:
  ...
  VTK_DEPRECATED_IN_9_0_0("Replaced by vtkPyramid::GetEdgePoints(vtkIdType, const vtkIdType*&)")
  void GetEdgePoints(int edgeId, int*& pts) override;
  vtkIdType GetFacePoints(vtkIdType faceId, const vtkIdType*& pts) override;
  // @deprecated Replaced by GetFacePoints(vtkIdType, const vtkIdType*&) as of VTK 9.0
  VTK_DEPRECATED_IN_9_0_0("Replaced by vtkPyramid::GetFacePoints(vtkIdType, const vtkIdType*&)")
