...
//------------------------------------------------------------------------------
unsigned int vtkAMRMetaData::GetNumberOfDataSets(unsigned int level) const
{
...
//------------------------------------------------------------------------------
unsigned int vtkAMRMetaData::GetTotalNumberOfBlocks()
{
  return this->NumBlocks.back();
}

//------------------------------------------------------------------------------
int vtkAMRMetaData::GetIndex(unsigned int level, unsigned int id) const
{
