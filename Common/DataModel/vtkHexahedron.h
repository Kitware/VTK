...
public:
   ...
   */
  VTK_DEPRECATED_IN_9_7_0("Use vtkMarchingCellsContourCases::GetHexahedronCase instead.")
  ...
  ///@{
  /**
   * Return the ids of the vertices defining edge/face (`edgeId`/\c faceId).
...
protected:
  vtkHexahedron();
  ~vtkHexahedron() override = default;
