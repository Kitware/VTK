...
#endif
  {
    ...
    else
    {
      ...
      if (cellIndex < nRightSideUp)
      {
        ...
        vtkLagrangeTriangle::BarycentricIndex(cellIndex, pointBIndices[0], order - 1);
        pointBIndices[0][2] += 1;
      ...
      else
      {
        ...
        {
          vtkLagrangeTriangle::BarycentricIndex(
...
//----------------------------------------------------------------------------
int vtkLagrangeTriangle::CellBoundary(
...
//----------------------------------------------------------------------------
int vtkLagrangeTriangle::EvaluatePosition(const double x[3], double closestPoint[3], int& subId,
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::EvaluateLocation(
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::Contour(double value, vtkDataArray* cellScalars,
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::Clip(double value, vtkDataArray* cellScalars,
...
//----------------------------------------------------------------------------
int vtkLagrangeTriangle::IntersectWithLine(
...
//----------------------------------------------------------------------------
int vtkLagrangeTriangle::Triangulate(int vtkNotUsed(index), vtkIdList* ptIds, vtkPoints* pts)
{
  pts->Reset();
  ptIds->Reset();
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::JacobianInverse(const double pcoords[3], double** inverse, double* derivs)
{
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::Derivatives(
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::ComputeParametricCoords(double* coords, vtkIdType order)
{
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::ToBarycentricIndex(vtkIdType index, vtkIdType* bindex)
{
#ifdef ENABLE_CACHING
...
vtkIdType vtkLagrangeTriangle::ToIndex(const vtkIdType* bindex)
{
  ...
  {
    this->IndexMap[cacheIdx] = vtkLagrangeTriangle::Index(bindex, this->GetOrder());
  }
...
//----------------------------------------------------------------------------
void vtkLagrangeTriangle::BarycentricIndex(vtkIdType index, vtkIdType* bindex, vtkIdType order)
{
