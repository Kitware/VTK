...
=========================================================================*/
// .NAME vtkNULLCell - an empty cell used as a place-holder during processing
// .SECTION Description
// vtkNULLCell is a concrete implementation of vtkCell. It is used
// during processing to represented a deleted element.

#ifndef __vtkNULLCell_h
#define __vtkNULLCell_h

#include "vtkCell.h"

class vtkNULLCell : public vtkCell
{
public:
  vtkNULLCell() {};
  vtkNULLCell(const vtkNULLCell& p);
  char *GetClassName() {return "vtkNULLCell";};

  vtkCell *MakeObject() {return new vtkNULLCell(*this);};
