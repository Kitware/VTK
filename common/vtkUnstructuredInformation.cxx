...
//------------------------------------------------------------------------------
vtkUnstructuredInformation* vtkUnstructuredInformation::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkUnstructuredInformation");
  if(ret)
    {
    return (vtkUnstructuredInformation*)ret;
    }
