...
// Description:
// Deep copy of cell.
vtkNULLCell::vtkNULLCell(const vtkNULLCell& vtkNotUsed(p))
{
}

int vtkNULLCell::EvaluatePosition(float  vtkNotUsed(x)[3], 
...
void vtkNULLCell::EvaluateLocation(int&  vtkNotUsed(subId), 
                                   float vtkNotUsed(pcoords)[3],
...
int vtkNULLCell::CellBoundary(int vtkNotUsed(subId), 
                            float vtkNotUsed(pcoords)[3], 
...
void vtkNULLCell::Contour(float vtkNotUsed(value), 
...
int vtkNULLCell::IntersectWithLine(float vtkNotUsed(p1)[3], 
...
int vtkNULLCell::Triangulate(int vtkNotUsed(index),
...
void vtkNULLCell::Derivatives(int vtkNotUsed(subId), 
			    float vtkNotUsed(pcoords)[3], 
...
void vtkNULLCell::Clip(float vtkNotUsed(value), 
                       vtkFloatScalars *vtkNotUsed(cellScalars), 
                       vtkPointLocator *vtkNotUsed(locator), 
                       vtkCellArray *vtkNotUsed(verts),    
                       vtkPointData *vtkNotUsed(inPD), 
