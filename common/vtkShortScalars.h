...
public:
  ...
  static vtkShortScalars *New() {return new vtkShortScalars;};
  const char *GetClassName() {return "vtkShortScalars";};
  ...
  float GetDataTypeMax() { return VTK_SHORT_MAX; }
...
inline short *vtkShortScalars::GetPointer(const int id)
{
...
// write. 
inline short *vtkShortScalars::WritePointer(const int id, const int number)
{
