/*=========================================================================
  ...
  Module:    vtkPolyConnectivityFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
// .NAME vtkPolyConnectivityFilter - extract polygonal data based on geometric connectivity
// .SECTION Description
// vtkPolyConnectivityFilter is a filter that extracts cells that share common 
...
// polygonal data.
//
// The behavior of vtkPolyConnectivityFilter can be modified by turning on the 
...
#ifndef __vtkPolyConnectivityFilter_h
#define __vtkPolyConnectivityFilter_h
...
public:
  ...
  ~vtkPolyConnectivityFilter();
  static vtkPolyConnectivityFilter *New() {return new vtkPolyConnectivityFilter;};
...
inline char *vtkPolyConnectivityFilter::GetExtractionModeAsString(void)
{
