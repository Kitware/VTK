...
void vtkDirectionEncoder::SetZeroNormalTolerance( float v )
{
  if ( this->ZeroNormalTolerance != v )
    ...
    this->ZeroNormalToleranceSquared = v*v;
    this->Modified();
    }
}
...
void vtkDirectionEncoder::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "Zero Normal Tolerance: " << 
    this->ZeroNormalTolerance << endl;
