...
vtkXGLPolyMapper::vtkXGLPolyMapper()
{
  this->Context = NULL;
  this->PL = NULL;
  this->PL2 = NULL;
...
float *vtkXGLPolyMapper::AddVertexComputeNormal(int npts, int pointSize, 
						 int *pts, vtkPoints *p, 
						 vtkColorScalars *c,
						 vtkTCoords *t, 
						 float *polyNorm)
...
float *vtkXGLPolyMapper::AddVertexWithNormal(int npts, int pointSize, 
					      int *pts, vtkPoints *p, 
					      vtkColorScalars *c,
...
void vtkXGLPolyMapper::Build(vtkPolyData *data, vtkColorScalars *c)
{
...
void vtkXGLPolyMapper::Draw(vtkRenderer *aren, vtkActor *act)
{
