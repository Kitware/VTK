...
vtkMesaProjectedPolyDataRayBounder::vtkMesaProjectedPolyDataRayBounder()
{
  this->DisplayList         = 0;
  this->DepthRangeBuffer    = NULL;
}

// Destruct the vtkMesaProjectedPolyDataRayBounder.  Free the 
...
void vtkMesaProjectedPolyDataRayBounder::Build( vtkPolyData *pdata )
{
  vtkCellArray   *polys;
  vtkCellArray   *strips;
  vtkPoints      *points;
...
void
vtkMesaProjectedPolyDataRayBounder::ReleaseGraphicsResources(vtkWindow *renWin)
{
  if (this->DisplayList)
    {
...
// Print the vtkMesaProjectedPolyDataRayBounder
