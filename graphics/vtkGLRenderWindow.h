...
=========================================================================*/
// .NAME vtkGLRenderWindow - SGI gl rendering window
// .SECTION Description
// vtkGLRenderWindow is a concrete implementation of the abstract class
// vtkRenderWindow. vtkGLRenderer interfaces to the Silicon Graphics gl
// graphics library.

#ifndef __vtkGLRenderWindow_h
#define __vtkGLRenderWindow_h
...
class VTK_EXPORT vtkGLRenderWindow : public vtkXRenderWindow
{
protected:
  int Gid;
  int MultiSamples;
