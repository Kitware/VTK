...
=========================================================================*/
// .NAME vtkGLPolyMapper - a PolyMapper for the SGI gl library
// .SECTION Description
// vtkGLPolyMapper is a subclass of vtkPolyMapperDevice. vtkGLPolyMapper is
// a geometric PolyMapper for the Silicon Graphics gl rendering library.

#ifndef __vtkGLPolyMapper_h
#define __vtkGLPolyMapper_h
...
class VTK_EXPORT vtkGLPolyMapper : public vtkPolyMapper
{
 public:
  vtkGLPolyMapper();
