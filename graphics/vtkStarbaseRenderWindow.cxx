/*=========================================================================
  ...
  Module:    vtkStarbaseRenderWindow.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
vtkStarbaseRenderWindow::vtkStarbaseRenderWindow()
{
  this->Fd = -1;
  if ( this->WindowName )
...
int vtkStarbaseRenderWindow::GetDesiredDepth ()
{
  int depth;
...
void vtkStarbaseRenderWindow::PrintSelf(ostream& os, vtkIndent indent)
{
...
unsigned char *vtkStarbaseRenderWindow::GetPixelData(int x1, int y1, 
						int x2, int y2,
						int front)
{
  int     xloop,yloop;
...
void vtkStarbaseRenderWindow::SetPixelData(int x1, int y1, int x2, int y2,
...
float *vtkStarbaseRenderWindow::GetRGBAPixelData(int x1, int y1, 
						int x2, int y2,
						int front)
{
...
float *vtkStarbaseRenderWindow::GetZbufferData( int x1, int y1, int x2, int y2  )
{
...
void vtkStarbaseRenderWindow::SetZbufferData( int x1, int y1, int x2, int y2,
                                          float *buffer )
{
