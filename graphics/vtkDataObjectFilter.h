...
=========================================================================*/
// .NAME vtkDataObjectFilter - abstract class for specifying filter behavior
// .SECTION Description
// vtkDataObjectFilter is an abstract class that specifies the interface for
...
public:
  ...
  const char *GetClassName() {return "vtkDataObjectFilter";};
