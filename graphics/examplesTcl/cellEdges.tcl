...
foreach cell "aVoxel aHexahedron aTetra aPixel aQuad aTriangle aPolygon aTriangleStrip" {
  ...
  vtkTubeFilter ${cell}Tubes
    ${cell}Tubes SetInput [${cell}Edges GetOutput]
    ${cell}Tubes SetRadius .1
  vtkPolyDataMapper ${cell}EdgesMapper
    ${cell}EdgesMapper SetInput [${cell}Tubes GetOutput]
  vtkActor ${cell}EdgesActor
    ${cell}EdgesActor SetMapper ${cell}EdgesMapper
eval  ${cell}EdgesActor SetPosition [${cell}Actor GetPosition]
    ren1 AddActor ${cell}EdgesActor
    [${cell}Actor GetProperty] SetRepresentationToWireframe
}
...
#renWin SetFileName "cellEdges.tcl.ppm"
