...
int vtkGLRenderer::UpdateCameras ()
{
...
void vtkGLRenderer::ClearLights (void)
{
  short curLight;
...
int vtkGLRenderer::UpdateLights ()
{
  vtkLight *light;
  short curLight;
  float status;
...
void vtkGLRenderer::DisplayToView()
{
  float vx,vy,vz;
  int sizex,sizey;
  int *size;
...
void vtkGLRenderer::ViewToDisplay()
{
  int dx,dy;
  int sizex,sizey;
  int *size;
...
int vtkGLRenderer::IsInViewport(int x,int y)
{
  int *size;
