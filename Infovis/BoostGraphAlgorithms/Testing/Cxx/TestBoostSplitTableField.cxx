...
int TestBoostSplitTableField(int argc, char* argv[])
{
  ...
  TestValue<vtkStdString>(table->GetColumnName(0), "PubID", "Column 0", error_count);
  TestValue<vtkStdString>(table->GetColumnName(1), "Author", "Column 1", error_count);
  TestValue<vtkStdString>(table->GetColumnName(2), "Journal", "Column 2", error_count);
  TestValue<vtkStdString>(table->GetColumnName(3), "Categories", "Column 3", error_count);
  TestValue<vtkStdString>(table->GetColumnName(4), "Accuracy", "Column 4", error_count);

  // Test a sampling of the table values ...
  TestValue<vtkStdString>(table->GetValue(0, 0).ToString(), "P001", "Value 0, 0", error_count);
  TestValue<vtkStdString>(table->GetValue(0, 1).ToString(), "Biff", "Value 0, 1", error_count);
  TestValue<vtkStdString>(table->GetValue(0, 2).ToString(), "American Journal of Spacecraft Music",
    "Value 0, 2", error_count);

  TestValue<vtkStdString>(table->GetValue(7, 0).ToString(), "P008", "value 7, 0", error_count);
  TestValue<vtkStdString>(table->GetValue(7, 1).ToString(), "Biff", "value 7, 1", error_count);
  TestValue<vtkStdString>(table->GetValue(7, 2).ToString(),
    "American Crafts and Holistic Medicine Quarterly", "value 7, 2", error_count);

  TestValue<vtkStdString>(table->GetValue(8, 0).ToString(), "P008", "value 8, 0", error_count);
  TestValue<vtkStdString>(table->GetValue(8, 1).ToString(), "Bob", "value 8, 1", error_count);
  TestValue<vtkStdString>(table->GetValue(8, 2).ToString(),
