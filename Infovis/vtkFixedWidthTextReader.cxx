...
vtkCxxRevisionMacro(vtkFixedWidthTextReader, "1.1");
            ...
            bool includeEmpties)
{
  ...
  while (thisField * fieldWidth < input.size())
    ...
    if (stripWhitespace)
      ...
      while (isspace(static_cast<int>(thisFieldText.at(startIndex))))
        {
        ++startIndex;
        }
      while (isspace(static_cast<int>(thisFieldText.at(endIndex))))
        {
        -- endIndex;
        }
