...
int TestSimple3DCirclesStrategy(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkPassThroughEdgeStrategy> edgeStrategy =
    vtkSmartPointer<vtkPassThroughEdgeStrategy>::New();
  vtkSmartPointer<vtkSimple3DCirclesStrategy> strategy =
    vtkSmartPointer<vtkSimple3DCirclesStrategy>::New();
