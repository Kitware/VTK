...
// Description:
// Returns the orientation of the actor as a rotation W about the vector of
// X,Y and Z.
float *vtkActor::GetOrientationWXYZ ()
{
  float cT, sT;
  float cP, sP;
  float cS, sS;
  ...
  // return the orientation of the transformation matrix
  orient = this->Transform.GetOrientation();
