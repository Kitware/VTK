...
vlStructuredPointsGeometryFilter::vlStructuredPointsGeometryFilter()
{
  this->Extent[0] = 0;
  this->Extent[1] = 100;
  this->Extent[2] = 0;
...
void vlStructuredPointsGeometryFilter::Execute()
{
  vlPointData *pd;
...
void vlStructuredPointsGeometryFilter::SetExtent(int iMin, int iMax, 
                                                 int jMin, int jMax, 
                                                 int kMin, int kMax)
{
  int extent[6];
...
void vlStructuredPointsGeometryFilter::SetExtent(int *extent)
{
  int i;
