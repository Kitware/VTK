...
#ifndef H5A_MODULE
#define vtkhdf5_H5Acreate_async(...)         vtkhdf5_H5Acreate_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Acreate_by_name_async(...) vtkhdf5_H5Acreate_by_name_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aopen_async(...)           vtkhdf5_H5Aopen_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aopen_by_name_async(...)   vtkhdf5_H5Aopen_by_name_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aopen_by_idx_async(...)    vtkhdf5_H5Aopen_by_idx_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Awrite_async(...)          vtkhdf5_H5Awrite_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aread_async(...)           vtkhdf5_H5Aread_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Arename_async(...)         vtkhdf5_H5Arename_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Arename_by_name_async(...) vtkhdf5_H5Arename_by_name_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aexists_async(...)         vtkhdf5_H5Aexists_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aexists_by_name_async(...) vtkhdf5_H5Aexists_by_name_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Aclose_async(...)          vtkhdf5_H5Aclose_async(__FILE__, __func__, __LINE__, __VA_ARGS__)

/* Define "wrapper" versions of function calls, to allow compile-time values to
 *      be passed in by language wrapper or library layer on top of HDF5.
 */
#define vtkhdf5_H5Acreate_async_wrap         H5_NO_EXPAND(vtkhdf5_H5Acreate_async)
#define vtkhdf5_H5Acreate_by_name_async_wrap H5_NO_EXPAND(vtkhdf5_H5Acreate_by_name_async)
#define vtkhdf5_H5Aopen_async_wrap           H5_NO_EXPAND(vtkhdf5_H5Aopen_async)
#define vtkhdf5_H5Aopen_by_name_async_wrap   H5_NO_EXPAND(vtkhdf5_H5Aopen_by_name_async)
#define vtkhdf5_H5Aopen_by_idx_async_wrap    H5_NO_EXPAND(vtkhdf5_H5Aopen_by_idx_async)
#define vtkhdf5_H5Awrite_async_wrap          H5_NO_EXPAND(vtkhdf5_H5Awrite_async)
#define vtkhdf5_H5Aread_async_wrap           H5_NO_EXPAND(vtkhdf5_H5Aread_async)
#define vtkhdf5_H5Arename_async_wrap         H5_NO_EXPAND(vtkhdf5_H5Arename_async)
#define vtkhdf5_H5Arename_by_name_async_wrap H5_NO_EXPAND(vtkhdf5_H5Arename_by_name_async)
#define vtkhdf5_H5Aexists_async_wrap         H5_NO_EXPAND(vtkhdf5_H5Aexists_async)
#define vtkhdf5_H5Aexists_by_name_async_wrap H5_NO_EXPAND(vtkhdf5_H5Aexists_by_name_async)
#define vtkhdf5_H5Aclose_async_wrap          H5_NO_EXPAND(vtkhdf5_H5Aclose_async)
#endif /* H5A_MODULE */
/// \endcond
