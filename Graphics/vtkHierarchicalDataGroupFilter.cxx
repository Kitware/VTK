...
vtkCxxRevisionMacro(vtkHierarchicalDataGroupFilter, "1.1");
...
int vtkHierarchicalDataGroupFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  output->SetNumberOfLevels(numInputs);
...
void vtkHierarchicalDataGroupFilter::AddInput(vtkDataObject* input)
{
  this->AddInput(0, input);
}

void vtkHierarchicalDataGroupFilter::AddInput(int index, vtkDataObject* input)
{
  if(input)
    {
...
int vtkHierarchicalDataGroupFilter::FillInputPortInformation(
