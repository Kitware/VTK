...
int TestMeanValueCoordinatesInterpolation2( int argc, char *argv[] )
{
  ...
  colorArray->InsertTupleValue(1, &r);
  colorArray->InsertTupleValue(2, &b);
  colorArray->InsertTupleValue(3, &b);
  ...
  pSource->SetOrigin(-1.0,0.0,-1.0);
  pSource->SetPoint1(1.0,0.0,-1.0);
  pSource->SetPoint2(-1.0,0.0,1.0);
  ...
  vtkSmartPointer<vtkPlaneSource> pSource1 = 
    vtkSmartPointer<vtkPlaneSource>::New();
  pSource1->SetOrigin(-1.0,-1.0,0.0);
  pSource1->SetPoint1(1.0,-1.0,0.0);
  pSource1->SetPoint2(-1.0,1.0,0.0);
  ...
  interpActor1->SetProperty(lightProp);
  
  renderer->AddActor(rectActor);
  renderer->AddActor(interpActor);
  renderer->AddActor(interpActor1);
