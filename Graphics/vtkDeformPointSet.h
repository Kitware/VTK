...
class VTK_GRAPHICS_EXPORT vtkDeformPointSet : public vtkPointSetAlgorithm
{
public:
  // Description:
  ...
  void SetControlMesh(vtkPolyData *controlMesh);
  vtkPolyData *GetControlMesh();
  ...
  // between executions. Thus flag is used to force reexecution and recomputation
  // of weights.
