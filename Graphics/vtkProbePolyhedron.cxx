...
class vtkProbePolyhedron::vtkVectorOfArrays : 
...
//----------------------------------------------------------------------------
void vtkProbePolyhedron::SetSource(vtkDataObject *input)
{
  this->SetInput(1, input);
}

//----------------------------------------------------------------------------
vtkDataObject *vtkProbePolyhedron::GetSource()
{
...
//----------------------------------------------------------------------------
void vtkProbePolyhedron::BuildFieldList(vtkDataSet* source)
{
  delete this->PointList;
  delete this->CellList;
...
// * output - output.
void vtkProbePolyhedron::InitializeForProbing(vtkDataSet* input,
  vtkDataSet* output)
{
...
//----------------------------------------------------------------------------
void vtkProbePolyhedron::Probe(vtkDataSet *input, vtkDataSet *source,
                           vtkDataSet *output)
{
...
//----------------------------------------------------------------------------
void vtkProbePolyhedron::ProbeEmptyPoints(vtkDataSet *input, 
  int srcIdx,
