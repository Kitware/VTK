...
struct GenerateTriangles
{
  ...
  void operator()(vtkIdType triId, vtkIdType endTriId)
  {
    ...
    bool isFirst = vtkSMPTools::GetSingleThread();
    vtkIdType checkAbortInterval = fmin((endTriId - triId) / 10 + 1, 1000);
...
struct CountPoints
{
  ...
  void operator()(vtkIdType slice, vtkIdType endSlice)
  {
    ...
    bool isFirst = vtkSMPTools::GetSingleThread();
    vtkIdType checkAbortInterval = fmin((endSlice - slice) / 10 + 1, 1000);
...
struct MapOffsets
{
  ...
  void operator()(vtkIdType batch, vtkIdType batchEnd)
  {
    ...
    vtkIdType checkAbortInterval = fmin((endBatchPt - prevPt) / 10 + 1, 1000);
