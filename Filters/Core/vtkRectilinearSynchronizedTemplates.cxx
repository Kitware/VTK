...
static void vtkRectilinearSynchronizedTemplatesInitializeOutput(TArray* inScalars, int* ext,
  vtkRectilinearGrid* input, vtkPolyData* o, vtkFloatArray* scalars, vtkFloatArray* normals,
...
//
struct ContourRectilinearGridFunctor
{
  template <class TArray>
  void operator()(TArray* inScalars, vtkIdType index, vtkRectilinearSynchronizedTemplates* self,
    int* exExt, vtkRectilinearGrid* data, vtkPolyData* output, bool outputTriangles)
  {
    ...
    vtkRectilinearSynchronizedTemplatesInitializeOutput(
      inScalars, exExt, data, output, newScalars, newNormals, newGradients);
  ...
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  ContourRectilinearGridFunctor functor;
  if (!vtkArrayDispatch::Dispatch::Execute(
        inScalars, functor, index, this, exExt, data, output, this->GenerateTriangles != 0))
  {
    functor(inScalars, index, this, exExt, data, output, this->GenerateTriangles != 0);
  }
