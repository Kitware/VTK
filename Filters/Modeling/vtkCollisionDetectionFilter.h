...
// between two polyhedral surfaces using two instances of
// vtkOBBTree. Set the polydata inputs, the tolerance and transforms
// or matrices. If CollisionMode is set to AllContacts, the Contacts
// output will be lines of contact.  If CollisionMode is FirstContact
// or HalfContacts then the Contacts output will be vertices.
// See below for an explanation of these options.
//
// This class can be used to clip one polydata surface with another,
// using the Contacts output as a loop
...
// who wrote t his class.  Thanks to Peter C. Everett
...
//ETX
  ...
  vtkAlgorithmOutput *aGetContactsOutputPort() {return this->GetOutputPort(2);}
