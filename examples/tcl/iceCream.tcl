...
vtkCleanPolyData cleanTheConeSurface;
    cleanTheConeSurface SetInput [theConeSurface GetOutput];
vtkPolyNormals coneNormals;
    coneNormals SetInput [cleanTheConeSurface GetOutput];
vtkPolyMapper coneMapper;
    coneMapper SetInput [coneNormals GetOutput];
...
vtkCleanPolyData cleanTheCreamSurface;
    cleanTheCreamSurface SetInput [theCreamSurface GetOutput];
vtkPolyNormals creamNormals;
    creamNormals SetInput [cleanTheCreamSurface GetOutput];
vtkPolyMapper creamMapper;
    creamMapper SetInput [creamNormals GetOutput];
