...
constexpr char TestLineWidgetEventLog[] = "# StreamVersion 1\n"
...
{
public:
  static vtkLWCallback* New() { return new vtkLWCallback; }
...
int TestLineWidget(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkLWCallback> myCallback = vtkSmartPointer<vtkLWCallback>::New();
  myCallback->PolyData = seeds;
  myCallback->Actor = streamline;

  // The plane widget is used probe the dataset.
  //
  vtkSmartPointer<vtkLineWidget> lineWidget = vtkSmartPointer<vtkLineWidget>::New();
