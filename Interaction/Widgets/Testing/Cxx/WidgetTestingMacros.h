...
#define EXERCISE_BASIC_INTERACTOR_OBSERVER_METHODS(object)                                         \
  {                                                                                                \
    ...
    if (object->GetInteractor() != nullptr)                                                        \
    {                                                                                              \
    ...
    if (object->GetDefaultRenderer() != nullptr)                                                   \
    {                                                                                              \
    ...
    {                                                                                              \
      std::cerr << "Error in Set/GetDefaultRenderer, default renderer is "                         \
                << (object->GetDefaultRenderer() == nullptr ? "nullptr" : "not null")              \
                << std::endl;                                                                      \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    {                                                                                              \
      ...
      std::cout << "Display " << x << "," << y << "," << z << " to world = " << worldPt[0] << ","  \
                << worldPt[1] << "," << worldPt[2] << "," << worldPt[3] << std::endl;              \
      double displayPt[3];                                                                         \
      object->ComputeWorldToDisplay(ren, x, y, z, displayPt);                                      \
      std::cout << "World " << x << "," << y << "," << z << " to display = " << displayPt[0]       \
                << "," << displayPt[1] << "," << displayPt[2] << std::endl;                        \
    }                                                                                              \
                                                                                                   \
...
#define EXERCISE_BASIC_PROP_METHODS(className, object)                                             \
  {                                                                                                \
    ...
    std::cout << "Has null required keys? " << object->HasKeys(nullptr) << std::endl;              \
                                                                                                   \
    std::cout << "Skipping the internal render calls, requires vtkViewPort. Testing get macros."   \
              << std::endl;                                                                        \
    std::cout << "HasTranslucentPolygonalGeometry = " << object->HasTranslucentPolygonalGeometry() \
              << std::endl;                                                                        \
...
#define EXERCISE_BASIC_REPRESENTATION_METHODS(className, object)                                   \
  ...
  std::cout << "InteractionState computed to be = " << object->ComputeInteractionState(10, 10, 0)  \
            << std::endl;                                                                          \
...
#define EXERCISE_BASIC_ANGLE_REPRESENTATION_METHODS(className, object)                             \
  {                                                                                                \
    ...
    std::cout << "GetPoint1WorldPosition = " << pos[0] << ", " << pos[1] << ", " << pos[2]         \
              << std::endl;                                                                        \
    object->GetCenterWorldPosition(pos);                                                           \
    std::cout << "GetCenterWorldPosition = " << pos[0] << ", " << pos[1] << ", " << pos[2]         \
              << std::endl;                                                                        \
    object->GetPoint2WorldPosition(pos);                                                           \
    std::cout << "GetPoint2WorldPosition = " << pos[0] << ", " << pos[1] << ", " << pos[2]         \
              << std::endl;                                                                        \
                                                                                                   \
    double pos2[3];                                                                                \
    pos2[0] = -99.0;                                                                               \
    ...
    if (pos[0] != pos2[0] || pos[0] != pos2[0] || pos[0] != pos2[0])                               \
    {                                                                                              \
      std::cerr << "Failed to SetCenterDisplayPosition to " << pos2[0] << ", " << pos2[1] << ", "  \
                << pos2[2] << ", instead got " << pos[0] << ", " << pos[1] << ", " << pos[2]       \
                << std::endl;                                                                      \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
                                                                                                   \
    ...
    if (pos[0] != pos2[0] || pos[0] != pos2[0] || pos[0] != pos2[0])                               \
    {                                                                                              \
      std::cerr << "Failed to SetPoint1DisplayPosition to " << pos2[0] << ", " << pos2[1] << ", "  \
                << pos2[2] << ", instead got " << pos[0] << ", " << pos[1] << ", " << pos[2]       \
                << std::endl;                                                                      \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    if (pos[0] != pos2[0] || pos[0] != pos2[0] || pos[0] != pos2[0])                               \
    {                                                                                              \
      std::cerr << "Failed to SetPoint2DisplayPosition to " << pos2[0] << ", " << pos2[1] << ", "  \
                << pos2[2] << ", instead got " << pos[0] << ", " << pos[1] << ", " << pos[2]       \
                << std::endl;                                                                      \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
                                                                                                   \
    vtkSmartPointer<vtkPointHandleRepresentation2D> phandle =                                      \
      vtkSmartPointer<vtkPointHandleRepresentation2D>::New();                                      \
    object->SetHandleRepresentation(phandle);                                                      \
    object->InstantiateHandleRepresentation();                                                     \
                                                                                                   \
    vtkSmartPointer<vtkHandleRepresentation> handleRep = nullptr;                                  \
  ...
  {                                                                                                \
    ...
    {                                                                                              \
      std::cerr << "Failure in Get/Set Position pos, expected " << pos[0] << ", " << pos[1]        \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    else                                                                                           \
    {                                                                                              \
    ...
    pos2 = object->GetPosition();                                                                  \
    if (pos2 == nullptr || pos2[0] != pos[0] || pos2[1] != pos[1])                                 \
    {                                                                                              \
      std::cerr << "Failure in Get/Set Position x,y, expected " << pos[0] << ", " << pos[1]        \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    if (pos2 == nullptr || pos2[0] != pos[0] || pos2[1] != pos[1])                                 \
    {                                                                                              \
      std::cerr << "Failure in Get/ Coordinate, expected " << pos[0] << ", " << pos[1]             \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
                                                                                                   \
    ...
    if (pos2 == nullptr || pos2[0] != pos[0] || pos2[1] != pos[1])                                 \
    {                                                                                              \
      std::cerr << "Failure in Get/Set Position2 pos, expected " << pos[0] << ", " << pos[1]       \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    pos[0] = 12.0;                                                                                 \
    ...
    if (pos2 == nullptr || pos2[0] != pos[0] || pos2[1] != pos[1])                                 \
    {                                                                                              \
      std::cerr << "Failure in Get/Set Position2 x,y, expected " << pos[0] << ", " << pos[1]       \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    if (pos2 == nullptr || pos2[0] != pos[0] || pos2[1] != pos[1])                                 \
    {                                                                                              \
      std::cerr << "Failure in Get/ Coordinate 2, expected " << pos[0] << ", " << pos[1]           \
                << ", instead got " << pos2[0] << ", " << pos2[1] << std::endl;                    \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
                                                                                                   \
...
#define EXERCISE_BASIC_HANDLE_REPRESENTATION_METHODS(className, object)                            \
  {                                                                                                \
    ...
    if (pos2[0] != wpos[0] || pos2[1] != wpos[1] || pos2[2] != wpos[2])                            \
    {                                                                                              \
      std::cerr << "Failure in Get WorldPosition pos2, expected " << wpos[0] << ", " << wpos[1]    \
                << ", " << wpos[2] << ", instead got " << pos2[0] << ", " << pos2[1] << ", "       \
                << pos2[2] << std::endl;                                                           \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    if (!pos3)                                                                                     \
    {                                                                                              \
      std::cerr << "Failure in double * GetWorldPosition , expected " << wpos[0] << ", "           \
                << wpos[1] << ", " << wpos[2] << ", instead got a null pointer." << std::endl;     \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    if (pos3[0] != wpos[0] || pos3[1] != wpos[1] || pos3[2] != wpos[2])                            \
    {                                                                                              \
      std::cerr << "Failure in double * GetWorldyPosition , expected " << wpos[0] << ", "          \
                << wpos[1] << ", " << wpos[2] << ", instead got " << pos3[0] << ", " << pos3[1]    \
                << ", " << pos3[2] << std::endl;                                                   \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    {                                                                                              \
      std::cerr << "Failure in GetDisplayPosition pos2, expected (0,0) instead got " << pos2[0]    \
                << ", " << pos2[1] << std::endl;                                                   \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    ...
    {                                                                                              \
      std::cerr                                                                                    \
        << "Failure in double * GetDisplayPosition, expected (0,0) instead got a null pointer."    \
        << std::endl;                                                                              \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    if (pos3[0] != 0 || pos3[1] != 0)                                                              \
    {                                                                                              \
      std::cerr << "Failure in double * GetDisplayPosition , expected (0,0) instead got "          \
                << pos3[0] << ", " << pos3[1] << std::endl;                                        \
      return EXIT_FAILURE;                                                                         \
    }                                                                                              \
    TEST_SET_GET_INT_RANGE(object, Tolerance, 2, 99);                                              \
