...
int TestCaptionWidget(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  rep->GetCaptionActor2D()->SetCaption("This is a test caption\nAnd it has two lines");
  rep->GetCaptionActor2D()->GetTextActor()->GetTextProperty()->SetJustificationToCentered();
  rep->GetCaptionActor2D()->GetTextActor()->GetTextProperty()->SetVerticalJustificationToCentered();

  vtkSmartPointer<vtkCaptionWidget> widget = vtkSmartPointer<vtkCaptionWidget>::New();
  ...
  std::cout << "Starting position of anchor: " << startingPosition[0] << ", " << startingPosition[1]
            << ", " << startingPosition[2] << std::endl;
  std::cout << "Ending position of anchor: " << endingPosition[0] << ", " << endingPosition[1]
