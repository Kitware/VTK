...
public:
  ...
  ~vtkAffineCallback() override { this->Transform->Delete(); }
...
int TestAffineWidget(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkAffineWidget> widget = vtkSmartPointer<vtkAffineWidget>::New();
  widget->SetInteractor(iren);
  widget->SetRepresentation(rep);

  vtkSmartPointer<vtkAffineCallback> acbk = vtkSmartPointer<vtkAffineCallback>::New();
  acbk->AffineRep = rep;
