...
constexpr char eventLog2[] = "# StreamVersion 1\n"
...
public:
  ...
  {
    vtkImplicitCylinderWidget* cylWidget = reinterpret_cast<vtkImplicitCylinderWidget*>(caller);
...
int TestImplicitCylinderWidget(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  vtkSmartPointer<vtkTICWCallback> myCallback = vtkSmartPointer<vtkTICWCallback>::New();
