...
constexpr char eventLog2LockNormalToCamera[] = "# StreamVersion 1\n"
...
{
public:
  static vtkEnableSlaveCallback* New() { return new vtkEnableSlaveCallback; }
  void Execute(vtkObject* caller, unsigned long, void*) override
  {
    ...
    if (keySym == "Control_L" || keySym == "Control_R")
    {
      lockMode = !lockMode;
      if (lockMode)
      {
...
int TestImplicitPlaneWidget2LockNormalToCamera(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
