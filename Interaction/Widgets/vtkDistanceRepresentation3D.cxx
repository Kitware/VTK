...
void vtkDistanceRepresentation3D::BuildRepresentation()
{
      ...
      this->Renderer->GetVTKWindow()->GetMTime() > this->BuildTime))
  {
    ...
    {
      numTicks =
        (this->RulerDistance <= 0.0 ? 1 : static_cast<int>(this->Distance / this->RulerDistance));
      numTicks =
        (numTicks > this->MaximumNumberOfRulerTicks ? this->MaximumNumberOfRulerTicks : numTicks);
...
void vtkDistanceRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "Label Scale Specified: " << (this->LabelScaleSpecified ? "true" : "false")
     << endl;
