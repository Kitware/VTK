...
void vtkImageTracerWidget::ProcessEvents(
...
void vtkImageTracerWidget::OnLeftButtonDown()
{
  ...
  // ignore this button
  if (this->State == vtkImageTracerWidget::Snapping)
  {
    return;
  }
...
{
  if (this->State == vtkImageTracerWidget::Outside || this->State == vtkImageTracerWidget::Start ||
