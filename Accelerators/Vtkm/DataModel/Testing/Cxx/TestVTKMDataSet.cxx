...
#ifdef Viskores_INCLUDED_IN_VTK
...
//------------------------------------------------------------------------------
inline void CoordsCopy(const viskores::cont::CoordinateSystem& coords, vtkPoints* points)
{
...
void TestCurvilinearDataSet()
{
  ...
  viskores::cont::CellSetStructured<3> css3;
