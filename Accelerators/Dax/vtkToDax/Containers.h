...
//this tag is used to construct triangle coordinates
struct vtkTrianglesContainerTag {};
...
template <typename ValueT>
class ArrayContainerControl<ValueT,vtkToDax::vtkTrianglesContainerTag>
{
public:
  typedef ValueT ValueType;
  //construct the portals type to be used with this container
  typedef vtkToDax::vtkTrianglesPortal<ValueType> PortalType;
  typedef vtkToDax::vtkTrianglesPortal<const ValueType> PortalConstType;
...
private:
  // Not implemented.
  ArrayContainerControl(const ArrayContainerControl<ValueType, vtkToDax::vtkTrianglesContainerTag> &src);
  void operator=(const ArrayContainerControl<ValueType, vtkToDax::vtkTrianglesContainerTag> &src);
