...
=========================================================================*/
// .NAME vtkGenericStreamer - abstract object implements integration of massless particle through vector field
// .SECTION Description
// vtkGenericStreamer is a filter that integrates a massless particle through a vector
// field. The integration is performed using second order Runge-Kutta method. 
// vtkGenericStreamer often serves as a base class for other classes that perform 
// numerical integration through a vector field (e.g., vtkStreamLine).
//
// Note that vtkGenericStreamer can integrate both forward and backward in time,
...
//
// vtkGenericStreamer integrates through any type of dataset. As a result, if the 
...
//
// vtkGenericStreamer implements the integration process in the Integrate() method.
// Because vtkGenericStreamer does not implement the Execute() method that its 
...
#ifndef __vtkGenericStreamer_h
#define __vtkGenericStreamer_h
...
class VTK_GENERIC_FILTERING_EXPORT vtkGenericStreamer : public vtkGenericDataSetToPolyDataFilter
{
public:
  vtkTypeRevisionMacro(vtkGenericStreamer,vtkGenericDataSetToPolyDataFilter);
...
private:
  vtkGenericStreamer(const vtkGenericStreamer&);  // Not implemented.
  void operator=(const vtkGenericStreamer&);  // Not implemented.
};

// Description:
// Return the integration direction as a character string.
inline const char *vtkGenericStreamer::GetIntegrationDirectionAsString()
{
