...
function(generate_index_html js test_args exit_after_test url output_file)
  ...
  if ("${js}" MATCHES "WebXR")
    file(READ "${CMAKE_CURRENT_LIST_DIR}/IWER/iwer.js" webxr_js)
    set(webxr_import "<script>${webxr_js}</script>")
  endif ()
...
function(is_interactive_test list_var result_var)
  if("-I" IN_LIST ${list_var})
