...
if(EXPAT_FOUND)
  ...
  if(NOT TARGET EXPAT::EXPAT)
    ...
    if(EXPAT_LIBRARY_RELEASE)
      set(expat_location "${EXPAT_LIBRARY_RELEASE}")
    elseif(EXPAT_LIBRARY_DEBUG)
      set(expat_location "${EXPAT_LIBRARY_DEBUG}")
    else ()
      set(expat_location "${EXPAT_LIBRARY}")
    endif ()
    vtk_detect_library_type(expat_library_type
      PATH "${expat_location}")
    unset(expat_location)
    ...
    if(EXPAT_LIBRARY_RELEASE)
      ...
      set_target_properties(EXPAT::EXPAT PROPERTIES
        ...
        IMPORTED_IMPLIB_DEBUG_RELEASE "${EXPAT_LIBRARY_RELEASE}")
    endif()
    ...
    if(NOT EXPAT_LIBRARY_RELEASE AND NOT EXPAT_LIBRARY_DEBUG)
      set_target_properties(TARGET EXPAT::EXPAT PROPERTIES
