...
if (VTK_BUILD_TESTING)
  ...
  if (CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
    set(VTK_TESTING_WASM_ENGINE "" CACHE FILEPATH "Path to a wasm runtime executable")
    mark_as_advanced(VTK_TESTING_WASM_ENGINE)
    set(VTK_TESTING_WASM_ENGINE_ARGUMENTS "" CACHE STRING "Space separated arguments passed to the wasm runtime executable")
    mark_as_advanced(VTK_TESTING_WASM_ENGINE_ARGUMENTS)
  endif ()
else ()
