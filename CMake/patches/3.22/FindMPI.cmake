...
get_filename_component(_FindMPI_MODULE_DIR
...
function(_MPI_try_staged_settings LANG MPI_TEST_FILE_NAME MODE RUN_BINARY SUPPRESS_ERRORS)
  ...
  set(SRC_DIR "${_FindMPI_MODULE_DIR}/FindMPI")
...
foreach(LANG IN ITEMS C CXX Fortran)
  ...
  if(_MPI_FIND_${LANG})
    ...
    if (CMAKE_VERSION VERSION_LESS "3.17")
      set(_MPI_name_mismatched)
    else ()
      set(_MPI_name_mismatched NAME_MISMATCHED)
    endif ()
    find_package_handle_standard_args(MPI_${LANG} ${_MPI_name_mismatched}
      REQUIRED_VARS ${MPI_${LANG}_REQUIRED_VARS}
      VERSION_VAR MPI_${LANG}_VERSION)
    unset(_MPI_name_mismatched)
