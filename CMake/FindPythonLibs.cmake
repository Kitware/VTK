...
MACRO(PYTHON_ADD_MODULE _NAME )
  ...
  IF(NOT DEFINED VTK_TARGET_SUPPORTS_SHARED_LIBS)
    SET(VTK_TARGET_SUPPORTS_SHARED_LIBS TRUE)
    SET(PYTHON_MODULE_${_NAME}_BUILD_SHARED TRUE CACHE STRING "Override wrong option" FORCE)
  ENDIF(NOT DEFINED VTK_TARGET_SUPPORTS_SHARED_LIBS)
