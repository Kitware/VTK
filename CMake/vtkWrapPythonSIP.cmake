...
MACRO(VTK_WRAP_PYTHON_SIP KIT SRC_LIST_NAME SOURCES)
  IF(NOT VTK_WRAP_PYTHON_SIP_EXE)
    MESSAGE(SEND_ERROR "VTK_WRAP_PYTHON_SIP_EXE not specified when calling VTK_WRAP_PYTHON_SIP")
  ENDIF(NOT VTK_WRAP_PYTHON_SIP_EXE)
  ...
  ADD_CUSTOM_COMMAND(
    OUTPUT ${SIP_OUT_SRCS}
    DEPENDS ${VTK_WRAP_PYTHON_SIP_EXE} ${SIP_IN_SRCS}
