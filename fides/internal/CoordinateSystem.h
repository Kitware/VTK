...
/// \brief Data model object for coordinate systems.
///
/// \c fides::datamodel::CoordinateSystem is responsible for creating
/// coordinate systems by loading data defined by the Fides
/// data model.
struct CoordinateSystem : public DataModelBase
{
  ...
  /// Reads and returns coordinate system tokens via the OutputBuilder.
  /// The heavy-lifting is handled by the underlying Array object.
  ...
  /// dataset data.
  void PostRead(fides::DataContainer& partitions, const fides::metadata::MetaData& selections);
