...
vtkTubeFilter streamTube2
    streamTube2 SetInput [streamer GetOutput]
    streamTube2 SetRadius 0.05
    streamTube2 SetNumberOfSides 6
    streamTube2 SetVaryRadiusToVaryRadiusByVector
    streamTube2 SetOnRatio 2
    streamTube2 SetOffset 1
vtkPolyDataMapper mapStreamTube2
    mapStreamTube2 SetInput [streamTube2 GetOutput]
    mapStreamTube2 ScalarVisibilityOff
vtkActor streamTubeActor2
    streamTubeActor2 SetMapper mapStreamTube2
    [streamTubeActor2 GetProperty] SetColor 0 0 1
...
ren1 AddActor streamTubeActor2
