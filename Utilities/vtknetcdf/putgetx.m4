 ...
 */
/* $Id: putgetx.m4,v 2.1 2010/04/11 04:15:42 dmh Exp $ */
        ...
        const size_t nelems, void* value, const nc_type memtype)
{
    ...
    case CASE(NC_BYTE,NC_UBYTE):
        status = getNCvx_schar_uchar(ncp,varp,start,nelems,(unsigned char*)value);
        break;
    ...
    case CASE(NC_BYTE,NC_INT):
        ...
        break;
    case CASE(NC_BYTE,NC_MEMLONG):
        status = getNCvx_schar_long(ncp,varp,start,nelems,(long*)value);
        break;
    ...
    case CASE(NC_SHORT,NC_INT):
        ...
        break;
    case CASE(NC_SHORT,NC_MEMLONG):
        status = getNCvx_short_long(ncp,varp,start,nelems,(long*)value);
        break;
    ...
    case CASE(NC_INT,NC_INT):
        ...
        break;
    case CASE(NC_INT,NC_MEMLONG):
        status = getNCvx_int_long(ncp,varp,start,nelems,(long*)value);
        break;
    ...
    case CASE(NC_FLOAT,NC_INT):
        ...
        break;
    case CASE(NC_FLOAT,NC_MEMLONG):
        status = getNCvx_float_long(ncp,varp,start,nelems,(long*)value);
        break;
    ...
    case CASE(NC_DOUBLE,NC_INT):
        ...
        break;
    case CASE(NC_DOUBLE,NC_MEMLONG):
        status = getNCvx_double_long(ncp,varp,start,nelems,(long*)value);
        break;
         ...
         const size_t nelems, const void* value, const nc_type memtype)
{
    ...
    case CASE(NC_BYTE,NC_INT):
        ...
        break;
    case CASE(NC_BYTE,NC_MEMLONG):
        status = putNCvx_schar_long(ncp,varp,start,nelems,(long*)value);
        break;
    case CASE(NC_BYTE,NC_FLOAT):
    ...
    case CASE(NC_SHORT,NC_INT):
        ...
        break;
    case CASE(NC_SHORT,NC_MEMLONG):
        status = putNCvx_short_long(ncp,varp,start,nelems,(long*)value);
        break;
    case CASE(NC_SHORT,NC_FLOAT):
    ...
    case CASE(NC_INT,NC_INT):
        ...
        break;
    case CASE(NC_INT,NC_MEMLONG):
        status = putNCvx_int_long(ncp,varp,start,nelems,(long*)value);
        break;
    case CASE(NC_INT,NC_FLOAT):
    ...
    case CASE(NC_FLOAT,NC_INT):
        ...
        break;
    case CASE(NC_FLOAT,NC_MEMLONG):
        status = putNCvx_float_long(ncp,varp,start,nelems,(long*)value);
        break;
    case CASE(NC_FLOAT,NC_FLOAT):
    ...
    case CASE(NC_DOUBLE,NC_INT):
        ...
        break;
    case CASE(NC_DOUBLE,NC_MEMLONG):
        status = putNCvx_double_long(ncp,varp,start,nelems,(long*)value);
        break;
    case CASE(NC_DOUBLE,NC_FLOAT):
