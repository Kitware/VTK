...
class VTKWRAPPINGPYTHON_EXPORT vtkPythonUtil
{
public:
...
extern VTKWRAPPINGPYTHON_EXPORT void vtkPythonVoidFunc(void *);
extern VTKWRAPPINGPYTHON_EXPORT void vtkPythonVoidFuncArgDelete(void *);
