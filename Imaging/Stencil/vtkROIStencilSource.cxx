...
static void vtkROIStencilSourceSubExtent(vtkROIStencilSource* self, const double origin[3],
  ...
  const int extent[6], const double origin[3], const double spacing[3])
{
  ...
  vtkROIStencilSourceSubExtent(self, origin, spacing, extent, subextent, icenter, iradius);
  ...
  vtkInformation* request, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  {
    case vtkROIStencilSource::BOX:
      result = vtkROIStencilSourceBox(this, data, extent, origin, spacing);
      break;
    case vtkROIStencilSource::ELLIPSOID:
      result = vtkROIStencilSourceEllipsoid(this, data, extent, origin, spacing);
      break;
    case vtkROIStencilSource::CYLINDERX:
      result = vtkROIStencilSourceCylinderX(this, data, extent, origin, spacing);
      break;
    case vtkROIStencilSource::CYLINDERY:
      result = vtkROIStencilSourceCylinderY(this, data, extent, origin, spacing);
      break;
    case vtkROIStencilSource::CYLINDERZ:
      result = vtkROIStencilSourceCylinderZ(this, data, extent, origin, spacing);
      break;
  }
