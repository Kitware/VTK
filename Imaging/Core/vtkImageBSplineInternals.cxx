...
/*--------------------------------------------------------------------------*/
int vtkImageBSplineInternals::GetPoleValues(double Pole[4], /* poles for b-spline */
...
template <class T>
int vtkImageBSplineGetInterpolationWeights(T xWeight[10], /* weights, size is SplineDegree + 1 */
    ...
    case 6L:
      ...
      xWeight[1] =
        (361.0 / 192.0 -
          w *
            (59.0 / 8.0 +
              w * (-185.0 / 16.0 + w * (25.0 / 3.0 + w * (-5.0 / 2.0 + w) * (1.0 / 2.0 + w))))) /
        120.0;
      xWeight[2] =
        (10543.0 / 960.0 +
          w *
            (-289.0 / 16.0 +
              w * (79.0 / 16.0 + w * (43.0 / 6.0 + w * (-17.0 / 4.0 + w * (-1.0 + w)))))) /
        48.0;
      w2 = w * w;
      xWeight[3] = (5887.0 / 320.0 - w2 * (231.0 / 16.0 - w2 * (21.0 / 4.0 - w2))) / 36.0;
      xWeight[4] =
        (10543.0 / 960.0 +
          w *
            (289.0 / 16.0 +
      ...
      xWeight[5] =
        1.0 - xWeight[0] - xWeight[1] - xWeight[2] - xWeight[3] - xWeight[4] - xWeight[6];
      break;
    case 7L:
      xWeight[0] = 1.0 - w;
      xWeight[0] *= xWeight[0];
      ...
      w2 = w * w;
      xWeight[1] =
        (120.0 / 7.0 + w * (-56.0 + w * (72.0 + w * (-40.0 + w2 * (12.0 + w * (-6.0 + w)))))) /
        720.0;
      xWeight[2] =
        (397.0 / 7.0 -
          w *
            (245.0 / 3.0 +
              w * (-15.0 + w * (-95.0 / 3.0 + w * (15.0 + w * (5.0 + w * (-5.0 + w))))))) /
        240.0;
      xWeight[3] = (2416.0 / 35.0 + w2 * (-48.0 + w2 * (16.0 + w2 * (-4.0 + w)))) / 144.0;
      xWeight[4] =
        (1191.0 / 35.0 - w * (-49.0 + w * (-9.0 + w * (19.0 + w * (-3.0 + w) * (-3.0 + w2))))) /
        144.0;
      xWeight[5] =
        (40.0 / 7.0 +
          w * (56.0 / 3.0 + w * (24.0 + w * (40.0 / 3.0 + w2 * (-4.0 + w * (-2.0 + w)))))) /
        240.0;
      xWeight[7] = w2;
      xWeight[7] *= xWeight[7] * xWeight[7];
      xWeight[7] *= w / 5040.0;
      xWeight[6] = 1.0 - xWeight[0] - xWeight[1] - xWeight[2] - xWeight[3] - xWeight[4] -
        xWeight[5] - xWeight[7];
      break;
    case 8L:
      xWeight[0] = 1.0 / 2.0 - w;
      ...
      xWeight[3] =
        ...
        720.0;
      xWeight[4] =
        (2337507.0 / 8960.0 + w2 * (-2601.0 / 16.0 + w2 * (387.0 / 8.0 + w2 * (-9.0 + w2)))) /
        576.0;
      xWeight[5] =
        (310661.0 / 1792.0 -
          w *
                ...
                (472.0 +
                  w *
                    (-504.0 +
                      w *
                        (308.0 +
                          w * (-84.0 + w * (-56.0 / 3.0 + w * (24.0 + w * (-8.0 + w))))))))) /
        40320.0;
      xWeight[2] =
        (3652.0 / 9.0 -
          w *
                ...
                (-952.0 +
                  w *
                    (938.0 / 3.0 +
                      w *
                        (112.0 +
                          w * (-119.0 + w * (56.0 / 3.0 + w * (14.0 + w * (-7.0 + w))))))))) /
        10080.0;
      xWeight[3] =
        (44117.0 / 42.0 +
          w *
            (-2427.0 / 2.0 +
              w *
                (66.0 +
                  w *
                    (434.0 +
                      w * (-129.0 + w * (-69.0 + w * (34.0 + w * (6.0 + w * (-6.0 + w))))))))) /
        4320.0;
      w2 = w * w;
      xWeight[4] =
        (78095.0 / 63.0 - w2 * (700.0 + w2 * (-190.0 + w2 * (100.0 / 3.0 + w2 * (-5.0 + w))))) /
        2880.0;
      xWeight[5] =
        (44117.0 / 63.0 +
          w *
              ...
              w *
                (44.0 +
                  w *
                    (-868.0 / 3.0 +
                      w *
                        (-86.0 + w * (46.0 + w * (68.0 / 3.0 + w * (-4.0 + w * (-4.0 + w))))))))) /
        2880.0;
      xWeight[6] =
        (3652.0 / 21.0 -
          w *
            (-867.0 / 2.0 +
              w *
                (-408.0 +
                  w *
                    (-134.0 +
                      w * (48.0 + w * (51.0 + w * (-4.0 + w) * (-1.0 + w) * (2.0 + w))))))) /
        4320.0;
      xWeight[7] =
        (251.0 / 18.0 +
          w *
              ...
              w *
                (118.0 +
                  w *
                    (126.0 +
                      w *
                        (77.0 + w * (21.0 + w * (-14.0 / 3.0 + w * (-6.0 + w * (-2.0 + w))))))))) /
        10080.0;
      xWeight[9] = w2 * w2;
      xWeight[9] *= xWeight[9] * w / 362880.0;
      xWeight[8] = 1.0 - xWeight[0] - xWeight[1] - xWeight[2] - xWeight[3] - xWeight[4] -
        xWeight[5] - xWeight[6] - xWeight[7] - xWeight[9];
      break;
    default:
      return (0);
  }
...
/*--------------------------------------------------------------------------*/
template <class T>
int vtkImageBSplineInterpolatedValue(const T* Bcoeff, /* input B-spline array of coefficients */
...
{ /* begin InterpolatedValue */
  ...
  if (Width > 1)
  {
    vtkImageBSplineInternals::GetInterpolationWeights(xWeight, s, SplineDegree);
  }
  if (Height > 1)
  {
    vtkImageBSplineInternals::GetInterpolationWeights(yWeight, t, SplineDegree);
  }
  if (Slices > 1)
  {
    vtkImageBSplineInternals::GetInterpolationWeights(zWeight, r, SplineDegree);
  }
...
/*--------------------------------------------------------------------------*/
int vtkImageBSplineInternals::GetInterpolationWeights(float weights[10], double w, long degree)
{
  return vtkImageBSplineGetInterpolationWeights(weights, w, degree);
}

int vtkImageBSplineInternals::GetInterpolationWeights(double weights[10], double w, long degree)
{
  return vtkImageBSplineGetInterpolationWeights(weights, w, degree);
}
