...
vtkImageMask::vtkImageMask()
{
  ...
  this->MaskedOutputValue[0] = this->MaskedOutputValue[1] = this->MaskedOutputValue[2] = 0.0;
  this->MaskAlpha = 1.0;
  ...
  vtkImageData*** inData, vtkImageData** outData, int outExt[6], int id)
{
  ...
  if (tExt[0] > outExt[0] || tExt[1] < outExt[1] || tExt[2] > outExt[2] || tExt[3] < outExt[3] ||
  ...
  {
    vtkErrorMacro(<< "Execute: image ScalarType (" << inData[0][0]->GetScalarType()
                  << ") must match out ScalarType (" << outData[0]->GetScalarType()
                  << "), and mask scalar type (" << inData[1][0]->GetScalarType()
  ...
  {
    vtkTemplateMacro(
      vtkImageMaskExecute(this, outExt, inData[0][0], static_cast<VTK_TT*>(inPtr1), inData[1][0],
        static_cast<unsigned char*>(inPtr2), outData[0], static_cast<VTK_TT*>(outPtr), id));
    default:
