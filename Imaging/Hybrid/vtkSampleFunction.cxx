...
public:
  ...
  {
  public:
    FunctionValueOp(vtkSampleFunctionAlgorithm<TT>* algo) { this->Algo = algo; }
  ...
  {
  public:
    FunctionGradientOp(vtkSampleFunctionAlgorithm<TT>* algo) { this->Algo = algo; }
    vtkSampleFunctionAlgorithm* Algo;
...
void vtkSampleFunction::ExecuteDataWithInformation(vtkDataObject* outp, vtkInformation* outInfo)
{
  ...
  {
    vtkTemplateMacro(vtkSampleFunctionAlgorithm<VTK_TT>::SampleAcrossImage(
      this, output, extent, (VTK_TT*)ptr, normals));
  }
