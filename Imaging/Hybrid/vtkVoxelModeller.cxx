...
int vtkVoxelModeller::RequestInformation(vtkInformation* vtkNotUsed(request),
...
int vtkVoxelModeller::RequestData(vtkInformation* vtkNotUsed(request),
...
int vtkVoxelModeller::FillInputPortInformation(int vtkNotUsed(port), vtkInformation* info)
{
