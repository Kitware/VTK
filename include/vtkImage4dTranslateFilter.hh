/*=========================================================================
  ...
  Module:    vtkImage4dTranslateFilter.hh
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
// .NAME vtkImage4dTranslateFilter - Same data, different bounds.
// .SECTION Description
// vtkImage4dTranslateFilter translates images to different pixel
...
#ifndef __vtkImage4dTranslateFilter_h
#define __vtkImage4dTranslateFilter_h


#include "vtkImageFilter.hh"

class vtkImage4dTranslateFilter : public vtkImageFilter
{
public:
  vtkImage4dTranslateFilter();
  char *GetClassName() {return "vtkImage4dTranslateFilter";};
