...
//==============================================================================
//          I N T E R N A L    E N Z O   R E A D E R
//==============================================================================
...
vtkAMREnzoReader::vtkAMREnzoReader()
{
  ...
  this->SelectionObserver->SetCallback(
      &vtkAMREnzoReader::SelectionModifiedCallback );
}
...
//      else
//        {
//          vtkErrorMacro("File is not a hierarchy or boundary file.");
//          return;
//        }
//
//      isValid = 1;
...
//    {
//      vtkErrorMacro( "Block index out-of-bounds!" );
//      return( -1 );
//    }
//
...
void vtkAMREnzoReader::GetBlock(
    int index, vtkHierarchicalBoxDataSet *hbds, vtkstd::vector< int > &idxcnt )
{
  // TODO: implement this
}
...
//----------------------------------------------------------------------------
void vtkAMREnzoReader::SelectionModifiedCallback(
    vtkObject*, unsigned long, void* clientdata, void*)
{
  static_cast<vtkAMREnzoReader*>(clientdata)->Modified();
}
