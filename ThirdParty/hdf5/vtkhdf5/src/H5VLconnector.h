...
#define vtkhdf5_H5VLattr_optional_op(...)     vtkhdf5_H5VLattr_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLdataset_optional_op(...)  vtkhdf5_H5VLdataset_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLdatatype_optional_op(...) vtkhdf5_H5VLdatatype_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLfile_optional_op(...)     vtkhdf5_H5VLfile_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLgroup_optional_op(...)    vtkhdf5_H5VLgroup_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLlink_optional_op(...)     vtkhdf5_H5VLlink_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5VLobject_optional_op(...)   vtkhdf5_H5VLobject_optional_op(__FILE__, __func__, __LINE__, __VA_ARGS__)

/* Define "wrapper" versions of function calls, to allow compile-time values to
 *      be passed in by language wrapper or library layer on top of HDF5.
 */
#define vtkhdf5_H5VLattr_optional_op_wrap     H5_NO_EXPAND(vtkhdf5_H5VLattr_optional_op)
#define vtkhdf5_H5VLdataset_optional_op_wrap  H5_NO_EXPAND(vtkhdf5_H5VLdataset_optional_op)
#define vtkhdf5_H5VLdatatype_optional_op_wrap H5_NO_EXPAND(vtkhdf5_H5VLdatatype_optional_op)
#define vtkhdf5_H5VLfile_optional_op_wrap     H5_NO_EXPAND(vtkhdf5_H5VLfile_optional_op)
#define vtkhdf5_H5VLgroup_optional_op_wrap    H5_NO_EXPAND(vtkhdf5_H5VLgroup_optional_op)
#define vtkhdf5_H5VLlink_optional_op_wrap     H5_NO_EXPAND(vtkhdf5_H5VLlink_optional_op)
#define vtkhdf5_H5VLobject_optional_op_wrap   H5_NO_EXPAND(vtkhdf5_H5VLobject_optional_op)
#endif /* H5VL_MODULE */
