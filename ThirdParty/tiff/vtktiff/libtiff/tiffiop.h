...
{
#endif
    vtktiff_EXPORT int _TIFFgetMode(TIFFOpenOptions *opts, thandle_t clientdata,
                            const char *mode, const char *module);
    vtktiff_EXPORT int _TIFFNoRowEncode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                uint16_t s);
    vtktiff_EXPORT int _TIFFNoStripEncode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                  uint16_t s);
    vtktiff_EXPORT int _TIFFNoTileEncode(TIFF *, uint8_t *pp, tmsize_t cc, uint16_t s);
    vtktiff_EXPORT int _TIFFNoRowDecode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                uint16_t s);
    vtktiff_EXPORT int _TIFFNoStripDecode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                  uint16_t s);
    vtktiff_EXPORT int _TIFFNoTileDecode(TIFF *, uint8_t *pp, tmsize_t cc, uint16_t s);
    vtktiff_EXPORT void _TIFFNoPostDecode(TIFF *tif, uint8_t *buf, tmsize_t cc);
    vtktiff_EXPORT int _TIFFNoPreCode(TIFF *tif, uint16_t s);
    vtktiff_EXPORT int _TIFFNoSeek(TIFF *tif, uint32_t off);
    vtktiff_EXPORT void _TIFFSwab16BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    vtktiff_EXPORT void _TIFFSwab24BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    vtktiff_EXPORT void _TIFFSwab32BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    vtktiff_EXPORT void _TIFFSwab64BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    ...
    vtktiff_EXPORT int _TIFFRewriteField(TIFF *, uint16_t, TIFFDataType, tmsize_t,
                                 void *);
    ...
    vtktiff_EXPORT uint32_t _TIFFDefaultStripSize(TIFF *tif, uint32_t s);
    vtktiff_EXPORT void _TIFFDefaultTileSize(TIFF *tif, uint32_t *tw, uint32_t *th);

    vtktiff_EXPORT void _TIFFsetByteArray(void **, const void *, uint32_t);
    vtktiff_EXPORT void _TIFFsetByteArrayExt(TIFF *, void **, const void *, uint32_t);
    vtktiff_EXPORT void _TIFFsetShortArray(uint16_t **, const uint16_t *, uint32_t);
    vtktiff_EXPORT void _TIFFsetShortArrayExt(TIFF *, uint16_t **, const uint16_t *,
                                      uint32_t);
    vtktiff_EXPORT void _TIFFsetLongArray(uint32_t **, const uint32_t *, uint32_t);
    vtktiff_EXPORT void _TIFFsetLongArrayExt(TIFF *, uint32_t **, const uint32_t *,
                                     uint32_t);
    vtktiff_EXPORT void _TIFFsetFloatArray(float **, const float *, uint32_t);
    vtktiff_EXPORT void _TIFFsetFloatArrayExt(TIFF *, float **, const float *,
                                      uint32_t);
    vtktiff_EXPORT void _TIFFsetDoubleArray(double **, const double *, uint32_t);
    vtktiff_EXPORT void _TIFFsetDoubleArrayExt(TIFF *, double **, const double *,
                                       uint32_t);
    ...
    vtktiff_EXPORT uint32_t _TIFFMultiply32(TIFF *, uint32_t, uint32_t, const char *);
    vtktiff_EXPORT uint64_t _TIFFMultiply64(TIFF *, uint64_t, uint64_t, const char *);
    vtktiff_EXPORT tmsize_t _TIFFMultiplySSize(TIFF *, tmsize_t, tmsize_t,
                                       const char *);
    vtktiff_EXPORT tmsize_t _TIFFCastUInt64ToSSize(TIFF *, uint64_t, const char *);
    vtktiff_EXPORT void *_TIFFCheckMalloc(TIFF *, tmsize_t, tmsize_t, const char *);
    vtktiff_EXPORT void *_TIFFCheckRealloc(TIFF *, void *, tmsize_t, tmsize_t,
                                   const char *);

    vtktiff_EXPORT double _TIFFUInt64ToDouble(uint64_t);
    vtktiff_EXPORT float _TIFFUInt64ToFloat(uint64_t);

    vtktiff_EXPORT float _TIFFClampDoubleToFloat(double);
    vtktiff_EXPORT uint32_t _TIFFClampDoubleToUInt32(double);

    vtktiff_EXPORT void _TIFFCleanupIFDOffsetAndNumberMaps(TIFF *tif);

    vtktiff_EXPORT tmsize_t _TIFFReadEncodedStripAndAllocBuffer(TIFF *tif,
                                                        uint32_t strip,
                                                        void **buf,
                                                        tmsize_t bufsizetoalloc,
                                                        tmsize_t size_to_read);
    vtktiff_EXPORT tmsize_t _TIFFReadEncodedTileAndAllocBuffer(TIFF *tif, uint32_t tile,
                                                       void **buf,
                                                       tmsize_t bufsizetoalloc,
                                                       tmsize_t size_to_read);
    vtktiff_EXPORT tmsize_t _TIFFReadTileAndAllocBuffer(TIFF *tif, void **buf,
                                                tmsize_t bufsizetoalloc,
                                                uint32_t x, uint32_t y,
...
#endif
#ifdef LERC_SUPPORT
    vtktiff_EXPORT int TIFFInitLERC(TIFF *tif, int);
#endif
#ifdef LZMA_SUPPORT
    vtktiff_EXPORT int TIFFInitLZMA(TIFF *, int);
#endif
#ifdef ZSTD_SUPPORT
    vtktiff_EXPORT int TIFFInitZSTD(TIFF *, int);
#endif
#ifdef WEBP_SUPPORT
    vtktiff_EXPORT int TIFFInitWebP(TIFF *, int);
#endif
    vtktiff_EXPORT const TIFFCodec _TIFFBuiltinCODECS[];
    vtktiff_EXPORT void TIFFCIELab16ToXYZ(TIFFCIELabToRGB *, uint32_t l, int32_t a,
                                  int32_t b, float *, float *, float *);

    vtktiff_EXPORT void *_TIFFmallocExt(TIFF *tif, tmsize_t s);
    vtktiff_EXPORT void *_TIFFcallocExt(TIFF *tif, tmsize_t nmemb, tmsize_t siz);
    vtktiff_EXPORT void *_TIFFreallocExt(TIFF *tif, void *p, tmsize_t s);
    vtktiff_EXPORT void _TIFFfreeExt(TIFF *tif, void *p);
