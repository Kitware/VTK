#ifndef fides_fides_mpi_h
#define fides_fides_mpi_h

#ifdef MPI_VERSION
#error \
  "Headers included out of order. <fides/fides_mpi.h> must be included before ANY header that pulls in <mpi.h>."
#endif
